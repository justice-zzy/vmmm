...
(x=q?d[n]:d[n].data)){f.isArray(a)?a=a.concat(f.map(a,f.camelCase)):a in x?a=[a]:(a=f.camelCase(a),a=a in x?[a]:a.split(" "));for(j=a.length;j--;)delete x[a[j]];if(q?!b(x):!f.isEmptyObject(x))return}if(!q&&(delete d[n].data,!b(d[n])))return;c?f.cleanData([g],!0):u.deleteExpando||d!=d.window?delete d[n]:d[n]=null}}}function r(){return!0}function C(){return!1}function D(){try{return y.activeElement}catch(g){}}function T(g){var a=mc.split("|");g=g.createDocumentFragment();if(g.createElement)for(;a.length;)g.createElement(a.pop());
return g}function P(g,a){var q,x,b=0,j=typeof g.getElementsByTagName!==ia?g.getElementsByTagName(a||"*"):typeof g.querySelectorAll!==ia?g.querySelectorAll(a||"*"):void 0;if(!j){j=[];for(q=g.childNodes||g;null!=(x=q[b]);b++)!a||f.nodeName(x,a)?j.push(x):f.merge(j,P(x,a))}return void 0===a||a&&f.nodeName(g,a)?f.merge([g],j):j}function tb(g){Ob.test(g.type)&&(g.defaultChecked=g.checked)}function Ma(g,a){return f.nodeName(g,"table")&&f.nodeName(11!==a.nodeType?a:a.firstChild,"tr")?g.getElementsByTagName("tbody")[0]||
g.appendChild(g.ownerDocument.createElement("tbody")):g}function L(g){g.type=(null!==f.find.attr(g,"type"))+"/"+g.type;return g}function Q(g){var a=Zc.exec(g.type);a?g.type=a[1]:g.removeAttribute("type");return g}function Xa(g,a){for(var q,x=0;null!=(q=g[x]);x++)f._data(q,"globalEval",!a||f._data(a[x],"globalEval"))}function Aa(g,a){if(1===a.nodeType&&f.hasData(g)){var q,x,b;x=f._data(g);var j=f._data(a,x),c=x.events;if(c)for(q in delete j.handle,j.events={},c){x=0;for(b=c[q].length;x<b;x++)f.event.add(a,
q,c[q][x])}j.data&&(j.data=f.extend({},j.data))}}function Ba(g,v){var q=f(v.createElement(g)).appendTo(v.body),x=a.getDefaultComputedStyle?a.getDefaultComputedStyle(q[0]).display:f.css(q[0],"display");q.detach();return x}function Ca(g){var a=y,q=nc[g];if(!q){q=Ba(g,a);if("none"===q||!q)gb=(gb||f("<iframe frameborder='0' width='0' height='0'/>")).appendTo(a.documentElement),a=(gb[0].contentWindow||gb[0].contentDocument).document,a.write(),a.close(),q=Ba(g,a),gb.detach();nc[g]=q}return q}function Na(g,
a){return{get:function(){var q=g();if(null!=q)if(q)delete this.get;else return(this.get=a).apply(this,arguments)}}}function ra(g,a){if(a in g)return a;for(var q=a.charAt(0).toUpperCase()+a.slice(1),x=a,f=oc.length;f--;)if(a=oc[f]+q,a in g)return a;return x}function hb(g,a){for(var q,x,b,j=[],c=0,d=g.length;c<d;c++)if(x=g[c],x.style)if(j[c]=f._data(x,"olddisplay"),q=x.style.display,a)!j[c]&&"none"===q&&(x.style.display=""),""===x.style.display&&ib(x)&&(j[c]=f._data(x,"olddisplay",Ca(x.nodeName)));
else if(!j[c]&&(b=ib(x),q&&"none"!==q||!b))f._data(x,"olddisplay",b?q:f.css(x,"display"));for(c=0;c<d;c++)if(x=g[c],x.style&&(!a||"none"===x.style.display||""===x.style.display))x.style.display=a?j[c]||"":"none";return g}function w(g,a,q){return(g=$c.exec(a))?Math.max(0,g[1]-(q||0))+(g[2]||"px"):a}function X(g,a,q,x,b){a=q===(x?"border":"content")?4:"width"===a?1:0;for(var j=0;4>a;a+=2)"margin"===q&&(j+=f.css(g,q+Oa[a],!0,b)),x?("content"===q&&(j-=f.css(g,"padding"+Oa[a],!0,b)),"margin"!==q&&(j-=
f.css(g,"border"+Oa[a]+"Width",!0,b))):(j+=f.css(g,"padding"+Oa[a],!0,b),"padding"!==q&&(j+=f.css(g,"border"+Oa[a]+"Width",!0,b)));return j}function ja(g,a,q){var x=!0,b="width"===a?g.offsetWidth:g.offsetHeight,j=Pa(g),c=u.boxSizing()&&"border-box"===f.css(g,"boxSizing",!1,j);if(0>=b||null==b){b=Qa(g,a,j);if(0>b||null==b)b=g.style[a];if(ub.test(b))return b;x=c&&(u.boxSizingReliable()||b===g.style[a]);b=parseFloat(b)||0}return b+X(g,a,q||(c?"border":"content"),x,j)+"px"}function G(g,a,q,b,f){return new G.prototype.init(g,
a,q,b,f)}function U(){setTimeout(function(){Ya=void 0});return Ya=f.now()}function ka(g,a){var q,b={height:g},f=0;for(a=a?1:0;4>f;f+=2-a)q=Oa[f],b["margin"+q]=b["padding"+q]=g;a&&(b.opacity=b.width=g);return b}function jb(g,a,q){for(var b,f=(kb[a]||[]).concat(kb["*"]),j=0,c=f.length;j<c;j++)if(b=f[j].call(q,a,g))return b}function lb(g,a,q){var b,j,c=0,d=vb.length,n=f.Deferred().always(function(){delete h.elem}),h=function(){if(j)return!1;for(var a=Ya||U(),a=Math.max(0,p.startTime+p.duration-a),v=
1-(a/p.duration||0),q=0,b=p.tweens.length;q<b;q++)p.tweens[q].run(v);n.notifyWith(g,[p,v,a]);if(1>v&&b)return a;n.resolveWith(g,[p]);return!1},p=n.promise({elem:g,props:f.extend({},a),opts:f.extend(!0,{specialEasing:{}},q),originalProperties:a,originalOptions:q,startTime:Ya||U(),duration:q.duration,tweens:[],createTween:function(a,v){var q=f.Tween(g,p.opts,a,v,p.opts.specialEasing[a]||p.opts.easing);p.tweens.push(q);return q},stop:function(a){var v=0,q=a?p.tweens.length:0;if(j)return this;for(j=!0;v<
q;v++)p.tweens[v].run(1);a?n.resolveWith(g,[p,a]):n.rejectWith(g,[p,a]);return this}});a=p.props;q=p.opts.specialEasing;var r,l,e,k;for(b in a)if(r=f.camelCase(b),l=q[r],e=a[b],f.isArray(e)&&(l=e[1],e=a[b]=e[0]),b!==r&&(a[r]=e,delete a[b]),(k=f.cssHooks[r])&&"expand"in k)for(b in e=k.expand(e),delete a[r],e)b in a||(a[b]=e[b],q[b]=l);else q[r]=l;for(;c<d;c++)if(b=vb[c].call(p,g,a,p.opts))return b;f.map(a,jb,p);f.isFunction(p.opts.start)&&p.opts.start.call(g,p);f.fx.timer(f.extend(h,{elem:g,anim:p,
queue:p.opts.queue}));return p.progress(p.opts.progress).done(p.opts.done,p.opts.complete).fail(p.opts.fail).always(p.opts.always)}function wb(g){return function(a,q){"string"!==typeof a&&(q=a,a="*");var b,j=0,c=a.toLowerCase().match(va)||[];if(f.isFunction(q))for(;b=c[j++];)"+"===b.charAt(0)?(b=b.slice(1)||"*",(g[b]=g[b]||[]).unshift(q)):(g[b]=g[b]||[]).push(q)}}function mb(g,a,q,b){function j(n){var p;c[n]=!0;f.each(g[n]||[],function(g,f){var n=f(a,q,b);if("string"===typeof n&&!d&&!c[n])return a.dataTypes.unshift(n),
j(n),!1;if(d)return!(p=n)});return p}var c={},d=g===Pb;return j(a.dataTypes[0])||!c["*"]&&j("*")}function la(g,a){var q,b,j=f.ajaxSettings.flatOptions||{};for(b in a)void 0!==a[b]&&((j[b]?g:q||(q={}))[b]=a[b]);q&&f.extend(!0,g,q);return g}function B(g,a,q,b){var j;if(f.isArray(a))f.each(a,function(a,v){q||bd.test(g)?b(g,v):B(g+"["+("object"===typeof v?a:"")+"]",v,q,b)});else if(!q&&"object"===f.type(a))for(j in a)B(g+"["+j+"]",a[j],q,b);else b(g,a)}function V(g){try{return g?new a.ActiveXObject("Microsoft.XMLHTTP"):
new a.XMLHttpRequest}catch(v){}}function $(){try{return new a.XMLHttpRequest}catch(g){}}function j(g){return f.isWindow(g)?g:9===g.nodeType?g.defaultView||g.parentWindow:!1}var n=[],p=n.slice,z=n.concat,H=n.push,I=n.indexOf,ea={},Qb=ea.toString,Za=ea.hasOwnProperty,Rb="".trim,u={},f=function(g,a){return new f.fn.init(g,a)},cd=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,dd=/^-ms-/,ed=/-([\da-z])/gi,fd=function(g,a){return a.toUpperCase()};f.fn=f.prototype={jquery:"1.11.0",constructor:f,selector:"",length:0,
...
this.length;g=+g+(0>g?a:0);return this.pushStack(0<=g&&g<a?[this[g]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:H,sort:n.sort,splice:n.splice};f.extend=f.fn.extend=function(){var g,a,q,b,j,c=arguments[0]||{},d=1,n=arguments.length,p=!1;"boolean"===typeof c&&(p=c,c=arguments[d]||{},d++);"object"!==typeof c&&!f.isFunction(c)&&(c={});d===n&&(c=this,d--);for(;d<n;d++)if(null!=(j=arguments[d]))for(b in j)g=c[b],q=j[b],c!==q&&(p&&q&&(f.isPlainObject(q)||(a=f.isArray(q)))?(a?
...
f.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(g,a){ea["[object "+a+"]"]=a.toLowerCase()});var N=a,K=function(g,a,q,b){var f,j,c,d,n;(a?a.ownerDocument||a:W)!==S&&ma(a);a=a||S;q=q||[];if(!g||"string"!==typeof g)return q;if(1!==(d=a.nodeType)&&9!==d)return[];if(aa&&!b){if(f=gd.exec(g))if(c=f[1])if(9===d)if((j=a.getElementById(c))&&j.parentNode){if(j.id===c)return q.push(j),q}else return q;else{if(a.ownerDocument&&(j=a.ownerDocument.getElementById(c))&&wa(a,
j)&&j.id===c)return q.push(j),q}else{if(f[2])return Da.apply(q,a.getElementsByTagName(g)),q;if((c=f[3])&&E.getElementsByClassName&&a.getElementsByClassName)return Da.apply(q,a.getElementsByClassName(c)),q}if(E.qsa&&(!R||!R.test(g))){j=f=M;c=a;n=9===d&&g;if(1===d&&"object"!==a.nodeName.toLowerCase()){d=sa(g);(f=a.getAttribute("id"))?j=f.replace(hd,"\\$&"):a.setAttribute("id",j);j="[id='"+j+"'] ";for(c=d.length;c--;)d[c]=j+xb(d[c]);c=Sb.test(g)&&fa(a.parentNode)||a;n=d.join(",")}if(n)try{return Da.apply(q,
c.querySelectorAll(n)),q}catch(p){}finally{f||a.removeAttribute("id")}}}var h;a:{g=g.replace(yb,"$1");j=sa(g);if(!b&&1===j.length){f=j[0]=j[0].slice(0);if(2<f.length&&"ID"===(h=f[0]).type&&E.getById&&9===a.nodeType&&aa&&F.relative[f[1].type]){a=(F.find.ID(h.matches[0].replace(Ea,Fa),a)||[])[0];if(!a){h=q;break a}g=g.slice(f.shift().value.length)}for(d=zb.needsContext.test(g)?0:f.length;d--;){h=f[d];if(F.relative[c=h.type])break;if(c=F.find[c])if(b=c(h.matches[0].replace(Ea,Fa),Sb.test(f[0].type)&&
fa(a.parentNode)||a)){f.splice(d,1);g=b.length&&xb(f);if(!g){Da.apply(q,b);h=q;break a}break}}}$a(g,j)(b,a,!aa,q,Sb.test(g)&&fa(a.parentNode)||a);h=q}return h},Tb=function(){function g(q,b){a.push(q+" ")>F.cacheLength&&delete g[a.shift()];return g[q+" "]=b}var a=[];return g},na=function(g){g[M]=!0;return g},oa=function(g){var a=S.createElement("div");try{return!!g(a)}catch(q){return!1}finally{a.parentNode&&a.parentNode.removeChild(a)}},Ub=function(g,a){for(var q=g.split("|"),b=g.length;b--;)F.attrHandle[q[b]]=
a},pc=function(g,a){var q=a&&g,b=q&&1===g.nodeType&&1===a.nodeType&&(~a.sourceIndex||Ga)-(~g.sourceIndex||Ga);if(b)return b;if(q)for(;q=q.nextSibling;)if(q===a)return-1;return g?1:-1},id=function(g){return function(a){return"input"===a.nodeName.toLowerCase()&&a.type===g}},jd=function(g){return function(a){var q=a.nodeName.toLowerCase();return("input"===q||"button"===q)&&a.type===g}},Ra=function(g){return na(function(a){a=+a;return na(function(q,b){for(var f,j=g([],q.length,a),c=j.length;c--;)if(q[f=
j[c]])q[f]=!(b[f]=q[f])})})},fa=function(g){return g&&typeof g.getElementsByTagName!==A&&g},qc=function(){},sa=function(g,a){var q,b,f,j,c,d,n;if(c=rc[g+" "])return a?0:c.slice(0);c=g;d=[];for(n=F.preFilter;c;){if(!q||(b=kd.exec(c)))b&&(c=c.slice(b[0].length)||c),d.push(f=[]);q=!1;if(b=ld.exec(c))q=b.shift(),f.push({value:q,type:b[0].replace(yb," ")}),c=c.slice(q.length);for(j in F.filter)if((b=zb[j].exec(c))&&(!n[j]||(b=n[j](b))))q=b.shift(),f.push({value:q,type:j,matches:b}),c=c.slice(q.length);
if(!q)break}return a?c.length:c?K.error(g):rc(g,d).slice(0)},xb=function(g){for(var a=0,q=g.length,b="";a<q;a++)b+=g[a].value;return b},Vb=function(g,a,q){var b=a.dir,f=q&&"parentNode"===b,j=md++;return a.first?function(a,q,v){for(;a=a[b];)if(1===a.nodeType||f)return g(a,q,v)}:function(a,q,v){var c,d,n=[Y,j];if(v)for(;a=a[b];){if((1===a.nodeType||f)&&g(a,q,v))return!0}else for(;a=a[b];)if(1===a.nodeType||f){d=a[M]||(a[M]={});if((c=d[b])&&c[0]===Y&&c[1]===j)return n[2]=c[2];d[b]=n;if(n[2]=g(a,q,v))return!0}}},
Wb=function(g){return 1<g.length?function(a,q,b){for(var f=g.length;f--;)if(!g[f](a,q,b))return!1;return!0}:g[0]},Sa=function(g,a,q,b,f){for(var j,c=[],d=0,n=g.length,p=null!=a;d<n;d++)if(j=g[d])if(!q||q(j,b,f))c.push(j),p&&a.push(d);return c},ab=function(g,a,q,b,f,j){b&&!b[M]&&(b=ab(b));f&&!f[M]&&(f=ab(f,j));return na(function(j,c,d,n){var p,h,da=[],r=[],e=c.length,l;if(!(l=j)){l=a||"*";for(var k=d.nodeType?[d]:d,A=[],z=0,C=k.length;z<C;z++)K(l,k[z],A);l=A}l=g&&(j||!a)?Sa(l,da,g,d,n):l;k=q?f||(j?
g:e||b)?[]:c:l;q&&q(l,k,d,n);if(b){p=Sa(k,r);b(p,[],d,n);for(d=p.length;d--;)if(h=p[d])k[r[d]]=!(l[r[d]]=h)}if(j){if(f||g){if(f){p=[];for(d=k.length;d--;)if(h=k[d])p.push(l[d]=h);f(null,k=[],p,n)}for(d=k.length;d--;)if((h=k[d])&&-1<(p=f?Ta.call(j,h):da[d]))j[p]=!(c[p]=h)}}else k=Sa(k===c?k.splice(e,k.length):k),f?f(null,c,k,n):Da.apply(c,k)})},bb=function(g){var a,q,b,f=g.length,j=F.relative[g[0].type];q=j||F.relative[" "];for(var c=j?1:0,d=Vb(function(g){return g===a},q,!0),n=Vb(function(g){return-1<
Ta.call(a,g)},q,!0),p=[function(g,q,b){return!j&&(b||q!==xa)||((a=q).nodeType?d(g,q,b):n(g,q,b))}];c<f;c++)if(q=F.relative[g[c].type])p=[Vb(Wb(p),q)];else{q=F.filter[g[c].type].apply(null,g[c].matches);if(q[M]){for(b=++c;b<f&&!F.relative[g[b].type];b++);return ab(1<c&&Wb(p),1<c&&xb(g.slice(0,c-1).concat({value:" "===g[c-2].type?"*":""})).replace(yb,"$1"),q,c<b&&bb(g.slice(c,b)),b<f&&bb(g=g.slice(b)),b<f&&xb(g))}p.push(q)}return Wb(p)},ya,E,F,Ha,sc,$a,xa,pa,za,ma,S,ba,aa,R,ga,ta,wa,M="sizzle"+-new Date,
W=N.document,Y=0,md=0,tc=Tb(),rc=Tb(),Ia=Tb(),ua=function(g,a){g===a&&(za=!0);return 0},A="undefined",Ga=-2147483648,ca={}.hasOwnProperty,O=[],qa=O.pop,cb=O.push,Da=O.push,uc=O.slice,Ta=O.indexOf||function(g){for(var a=0,q=this.length;a<q;a++)if(this[a]===g)return a;return-1},vc="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),wc="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+vc+")|)|)[\\x20\\t\\r\\n\\f]*\\]",
Xb=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"+wc.replace(3,8)+")*)|.*)\\)|)",yb=RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$","g"),kd=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,ld=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,nd=RegExp("=[\\x20\\t\\r\\n\\f]*([^\\]'\"]*?)[\\x20\\t\\r\\n\\f]*\\]","g"),od=RegExp(Xb),pd=RegExp("^"+vc+"$"),zb={ID:/^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,CLASS:/^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,
...
"i")},qd=/^(?:input|select|textarea|button)$/i,rd=/^h\d$/i,nb=/^[^{]+\{\s*\[native \w/,gd=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,Sb=/[+~]/,hd=/'|\\/g,Ea=RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)","ig"),Fa=function(g,a,q){g="0x"+a-65536;return g!==g||q?a:0>g?String.fromCharCode(g+65536):String.fromCharCode(g>>10|55296,g&1023|56320)};try{Da.apply(O=uc.call(W.childNodes),W.childNodes),O[W.childNodes.length].nodeType}catch(Yd){Da={apply:O.length?function(g,a){cb.apply(g,uc.call(a))}:
function(g,a){for(var q=g.length,b=0;g[q++]=a[b++];);g.length=q-1}}}E=K.support={};sc=K.isXML=function(g){return(g=g&&(g.ownerDocument||g).documentElement)?"HTML"!==g.nodeName:!1};ma=K.setDocument=function(g){var a=g?g.ownerDocument||g:W;g=a.defaultView;if(a===S||9!==a.nodeType||!a.documentElement)return S;S=a;ba=a.documentElement;aa=!sc(a);g&&g!==g.top&&(g.addEventListener?g.addEventListener("unload",function(){ma()},!1):g.attachEvent&&g.attachEvent("onunload",function(){ma()}));E.attributes=oa(function(g){g.className=
"i";return!g.getAttribute("className")});E.getElementsByTagName=oa(function(g){g.appendChild(a.createComment(""));return!g.getElementsByTagName("*").length});E.getElementsByClassName=nb.test(a.getElementsByClassName)&&oa(function(g){g.innerHTML="<div class='a'></div><div class='a i'></div>";g.firstChild.className="i";return 2===g.getElementsByClassName("i").length});E.getById=oa(function(g){ba.appendChild(g).id=M;return!a.getElementsByName||!a.getElementsByName(M).length});E.getById?(F.find.ID=function(g,
a){if(typeof a.getElementById!==A&&aa){var b=a.getElementById(g);return b&&b.parentNode?[b]:[]}},F.filter.ID=function(g){var a=g.replace(Ea,Fa);return function(g){return g.getAttribute("id")===a}}):(delete F.find.ID,F.filter.ID=function(g){var a=g.replace(Ea,Fa);return function(g){return(g=typeof g.getAttributeNode!==A&&g.getAttributeNode("id"))&&g.value===a}});F.find.TAG=E.getElementsByTagName?function(g,a){if(typeof a.getElementsByTagName!==A)return a.getElementsByTagName(g)}:function(g,a){var b,
v=[],f=0,j=a.getElementsByTagName(g);if("*"===g){for(;b=j[f++];)1===b.nodeType&&v.push(b);return v}return j};F.find.CLASS=E.getElementsByClassName&&function(g,a){if(typeof a.getElementsByClassName!==A&&aa)return a.getElementsByClassName(g)};ga=[];R=[];if(E.qsa=nb.test(a.querySelectorAll))oa(function(g){g.innerHTML="<select t=''><option selected=''></option></select>";g.querySelectorAll("[t^='']").length&&R.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");g.querySelectorAll("[selected]").length||R.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");
g.querySelectorAll(":checked").length||R.push(":checked")}),oa(function(g){var b=a.createElement("input");b.setAttribute("type","hidden");g.appendChild(b).setAttribute("name","D");g.querySelectorAll("[name=d]").length&&R.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");g.querySelectorAll(":enabled").length||R.push(":enabled",":disabled");g.querySelectorAll("*,:x");R.push(",.*:")});(E.matchesSelector=nb.test(ta=ba.webkitMatchesSelector||ba.mozMatchesSelector||ba.oMatchesSelector||ba.msMatchesSelector))&&
oa(function(g){E.disconnectedMatch=ta.call(g,"div");ta.call(g,"[s!='']:x");ga.push("!=",Xb)});R=R.length&&RegExp(R.join("|"));ga=ga.length&&RegExp(ga.join("|"));wa=(g=nb.test(ba.compareDocumentPosition))||nb.test(ba.contains)?function(g,a){var b=9===g.nodeType?g.documentElement:g,v=a&&a.parentNode;return g===v||!(!v||!(1===v.nodeType&&(b.contains?b.contains(v):g.compareDocumentPosition&&g.compareDocumentPosition(v)&16)))}:function(g,a){if(a)for(;a=a.parentNode;)if(a===g)return!0;return!1};ua=g?function(g,
b){if(g===b)return za=!0,0;var f=!g.compareDocumentPosition-!b.compareDocumentPosition;if(f)return f;f=(g.ownerDocument||g)===(b.ownerDocument||b)?g.compareDocumentPosition(b):1;return f&1||!E.sortDetached&&b.compareDocumentPosition(g)===f?g===a||g.ownerDocument===W&&wa(W,g)?-1:b===a||b.ownerDocument===W&&wa(W,b)?1:pa?Ta.call(pa,g)-Ta.call(pa,b):0:f&4?-1:1}:function(g,b){if(g===b)return za=!0,0;var f,j=0;f=g.parentNode;var c=b.parentNode,d=[g],n=[b];if(!f||!c)return g===a?-1:b===a?1:f?-1:c?1:pa?Ta.call(pa,
g)-Ta.call(pa,b):0;if(f===c)return pc(g,b);for(f=g;f=f.parentNode;)d.unshift(f);for(f=b;f=f.parentNode;)n.unshift(f);for(;d[j]===n[j];)j++;return j?pc(d[j],n[j]):d[j]===W?-1:n[j]===W?1:0};return a};K.matches=function(g,a){return K(g,null,null,a)};K.matchesSelector=function(g,a){(g.ownerDocument||g)!==S&&ma(g);a=a.replace(nd,"='$1']");if(E.matchesSelector&&aa&&(!ga||!ga.test(a))&&(!R||!R.test(a)))try{var b=ta.call(g,a);if(b||E.disconnectedMatch||g.document&&11!==g.document.nodeType)return b}catch(f){}return 0<
K(a,S,null,[g]).length};K.contains=function(g,a){(g.ownerDocument||g)!==S&&ma(g);return wa(g,a)};K.attr=function(g,a){(g.ownerDocument||g)!==S&&ma(g);var b=F.attrHandle[a.toLowerCase()],b=b&&ca.call(F.attrHandle,a.toLowerCase())?b(g,a,!aa):void 0;return void 0!==b?b:E.attributes||!aa?g.getAttribute(a):(b=g.getAttributeNode(a))&&b.specified?b.value:null};K.error=function(g){throw Error("Syntax error, unrecognized expression: "+g);};K.uniqueSort=function(g){var a,b=[],f=0,j=0;za=!E.detectDuplicates;
pa=!E.sortStable&&g.slice(0);g.sort(ua);if(za){for(;a=g[j++];)a===g[j]&&(f=b.push(j));for(;f--;)g.splice(b[f],1)}pa=null;return g};Ha=K.getText=function(g){var a,b="",f=0;if(a=g.nodeType)if(1===a||9===a||11===a){if("string"===typeof g.textContent)return g.textContent;for(g=g.firstChild;g;g=g.nextSibling)b+=Ha(g)}else{if(3===a||4===a)return g.nodeValue}else for(;a=g[f++];)b+=Ha(a);return b};F=K.selectors={cacheLength:50,createPseudo:na,match:zb,attrHandle:{},find:{},relative:{">":{dir:"parentNode",
first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(g){g[1]=g[1].replace(Ea,Fa);g[3]=(g[4]||g[5]||"").replace(Ea,Fa);"~="===g[2]&&(g[3]=" "+g[3]+" ");return g.slice(0,4)},CHILD:function(g){g[1]=g[1].toLowerCase();"nth"===g[1].slice(0,3)?(g[3]||K.error(g[0]),g[4]=+(g[4]?g[5]+(g[6]||1):2*("even"===g[3]||"odd"===g[3])),g[5]=+(g[7]+g[8]||"odd"===g[3])):g[3]&&K.error(g[0]);return g},PSEUDO:function(g){var a,b=!g[5]&&g[2];if(zb.CHILD.test(g[0]))return null;
...
g.className||typeof g.getAttribute!==A&&g.getAttribute("class")||"")})},ATTR:function(g,a,b){return function(f){f=K.attr(f,g);if(null==f)return"!="===a;if(!a)return!0;f+="";return"="===a?f===b:"!="===a?f!==b:"^="===a?b&&0===f.indexOf(b):"*="===a?b&&-1<f.indexOf(b):"$="===a?b&&f.slice(-b.length)===b:"~="===a?-1<(" "+f+" ").indexOf(b):"|="===a?f===b||f.slice(0,b.length+1)===b+"-":!1}},CHILD:function(g,a,b,f,j){var c="nth"!==g.slice(0,3),d="last"!==g.slice(-4),n="of-type"===a;return 1===f&&0===j?function(g){return!!g.parentNode}:
function(a,b,q){var v,p,h,r,k;b=c!==d?"nextSibling":"previousSibling";var l=a.parentNode,e=n&&a.nodeName.toLowerCase();q=!q&&!n;if(l){if(c){for(;b;){for(p=a;p=p[b];)if(n?p.nodeName.toLowerCase()===e:1===p.nodeType)return!1;k=b="only"===g&&!k&&"nextSibling"}return!0}k=[d?l.firstChild:l.lastChild];if(d&&q){q=l[M]||(l[M]={});v=q[g]||[];r=v[0]===Y&&v[1];h=v[0]===Y&&v[2];for(p=r&&l.childNodes[r];p=++r&&p&&p[b]||(h=r=0)||k.pop();)if(1===p.nodeType&&++h&&p===a){q[g]=[Y,r,h];break}}else if(q&&(v=(a[M]||(a[M]=
{}))[g])&&v[0]===Y)h=v[1];else for(;p=++r&&p&&p[b]||(h=r=0)||k.pop();)if((n?p.nodeName.toLowerCase()===e:1===p.nodeType)&&++h)if(q&&((p[M]||(p[M]={}))[g]=[Y,h]),p===a)break;h-=j;return h===f||0===h%f&&0<=h/f}}},PSEUDO:function(g,a){var b,f=F.pseudos[g]||F.setFilters[g.toLowerCase()]||K.error("unsupported pseudo: "+g);return f[M]?f(a):1<f.length?(b=[g,g,"",a],F.setFilters.hasOwnProperty(g.toLowerCase())?na(function(g,b){for(var q,j=f(g,a),c=j.length;c--;)q=Ta.call(g,j[c]),g[q]=!(b[q]=j[c])}):function(g){return f(g,
0,b)}):f}},pseudos:{not:na(function(g){var a=[],b=[],f=$a(g.replace(yb,"$1"));return f[M]?na(function(g,a,b,q){q=f(g,null,q,[]);for(var v=g.length;v--;)if(b=q[v])g[v]=!(a[v]=b)}):function(g,j,c){a[0]=g;f(a,null,c,b);return!b.pop()}}),has:na(function(g){return function(a){return 0<K(g,a).length}}),contains:na(function(g){return function(a){return-1<(a.textContent||a.innerText||Ha(a)).indexOf(g)}}),lang:na(function(g){pd.test(g||"")||K.error("unsupported lang: "+g);g=g.replace(Ea,Fa).toLowerCase();
return function(a){var b;do if(b=aa?a.lang:a.getAttribute("xml:lang")||a.getAttribute("lang"))return b=b.toLowerCase(),b===g||0===b.indexOf(g+"-");while((a=a.parentNode)&&1===a.nodeType);return!1}}),target:function(g){var a=N.location&&N.location.hash;return a&&a.slice(1)===g.id},root:function(g){return g===ba},focus:function(g){return g===S.activeElement&&(!S.hasFocus||S.hasFocus())&&!(!g.type&&!g.href&&!~g.tabIndex)},enabled:function(g){return!1===g.disabled},disabled:function(g){return!0===g.disabled},
...
b+a:b;++b<a;)g.push(b);return g})}};F.pseudos.nth=F.pseudos.eq;for(ya in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})F.pseudos[ya]=id(ya);for(ya in{submit:!0,reset:!0})F.pseudos[ya]=jd(ya);qc.prototype=F.filters=F.pseudos;F.setFilters=new qc;$a=K.compile=function(g,a){var b,f=[],j=[],c=Ia[g+" "];if(!c){a||(a=sa(g));for(b=a.length;b--;)c=bb(a[b]),c[M]?f.push(c):j.push(c);var d=0<f.length,n=0<j.length;b=function(g,a,b,q,v){var c,p,h,r=0,da="0",l=g&&[],k=[],e=xa,A=g||n&&F.find.TAG("*",v),z=Y+=
null==e?1:Math.random()||0.1,C=A.length;for(v&&(xa=a!==S&&a);da!==C&&null!=(c=A[da]);da++){if(n&&c){for(p=0;h=j[p++];)if(h(c,a,b)){q.push(c);break}v&&(Y=z)}d&&((c=!h&&c)&&r--,g&&l.push(c))}r+=da;if(d&&da!==r){for(p=0;h=f[p++];)h(l,k,a,b);if(g){if(0<r)for(;da--;)!l[da]&&!k[da]&&(k[da]=qa.call(q));k=Sa(k)}Da.apply(q,k);v&&(!g&&0<k.length&&1<r+f.length)&&K.uniqueSort(q)}v&&(Y=z,xa=e);return l};b=d?na(b):b;c=Ia(g,b)}return c};E.sortStable=M.split("").sort(ua).join("")===M;E.detectDuplicates=!!za;ma();
E.sortDetached=oa(function(g){return g.compareDocumentPosition(S.createElement("div"))&1});oa(function(g){g.innerHTML="<a href='#'></a>";return"#"===g.firstChild.getAttribute("href")})||Ub("type|href|height|width",function(g,a,b){if(!b)return g.getAttribute(a,"type"===a.toLowerCase()?1:2)});(!E.attributes||!oa(function(g){g.innerHTML="<input/>";g.firstChild.setAttribute("value","");return""===g.firstChild.getAttribute("value")}))&&Ub("value",function(g,a,b){if(!b&&"input"===g.nodeName.toLowerCase())return g.defaultValue});
oa(function(g){return null==g.getAttribute("disabled")})||Ub("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",function(g,a,b){var f;if(!b)return!0===g[a]?a.toLowerCase():(f=g.getAttributeNode(a))&&f.specified?f.value:null});f.find=K;f.expr=K.selectors;f.expr[":"]=f.expr.pseudos;f.unique=K.uniqueSort;f.text=K.getText;f.isXMLDoc=K.isXML;f.contains=K.contains;var xc=f.expr.match.needsContext,yc=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Wc=
...
g:g;return b},filter:function(g){return this.pushStack(e(this,g||[],!1))},not:function(g){return this.pushStack(e(this,g||[],!0))},is:function(g){return!!e(this,"string"===typeof g&&xc.test(g)?f(g):g||[],!1).length}});var ob,y=a.document,sd=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;(f.fn.init=function(g,a){var b,j;if(!g)return this;if("string"===typeof g){if((b="<"===g.charAt(0)&&">"===g.charAt(g.length-1)&&3<=g.length?[null,g,null]:sd.exec(g))&&(b[1]||!a)){if(b[1]){if(a=a instanceof f?a[0]:a,f.merge(this,
f.parseHTML(b[1],a&&a.nodeType?a.ownerDocument||a:y,!0)),yc.test(b[1])&&f.isPlainObject(a))for(b in a)if(f.isFunction(this[b]))this[b](a[b]);else this.attr(b,a[b])}else{if((j=y.getElementById(b[2]))&&j.parentNode){if(j.id!==b[2])return ob.find(g);this.length=1;this[0]=j}this.context=y;this.selector=g}return this}return!a||a.jquery?(a||ob).find(g):this.constructor(a).find(g)}if(g.nodeType)return this.context=this[0]=g,this.length=1,this;if(f.isFunction(g))return"undefined"!==typeof ob.ready?ob.ready(g):
g(f);void 0!==g.selector&&(this.selector=g.selector,this.context=g.context);return f.makeArray(g,this)}).prototype=f.fn;ob=f(y);var td=/^(?:parents|prev(?:Until|All))/,ud={children:!0,contents:!0,next:!0,prev:!0};f.extend({dir:function(g,a,b){var j=[];for(g=g[a];g&&9!==g.nodeType&&(void 0===b||1!==g.nodeType||!f(g).is(b));)1===g.nodeType&&j.push(g),g=g[a];return j},sibling:function(g,a){for(var b=[];g;g=g.nextSibling)1===g.nodeType&&g!==a&&b.push(g);return b}});f.fn.extend({has:function(g){var a,
...
j){var c=f.map(this,a,b);"Until"!==g.slice(-5)&&(j=b);j&&"string"===typeof j&&(c=f.filter(j,c));1<this.length&&(ud[g]||(c=f.unique(c)),td.test(g)&&(c=c.reverse()));return this.pushStack(c)}});var va=/\S+/g,zc={};f.Callbacks=function(g){var a;if("string"===typeof g){if(!(a=zc[g])){a=g;var b=zc[a]={};f.each(a.match(va)||[],function(g,a){b[a]=!0});a=b}}else a=f.extend({},g);g=a;var j,c,d,n,p,h,r=[],k=!g.once&&[],l=function(a){c=g.memory&&a;d=!0;p=h||0;h=0;n=r.length;for(j=!0;r&&p<n;p++)if(!1===r[p].apply(a[0],
a[1])&&g.stopOnFalse){c=!1;break}j=!1;r&&(k?k.length&&l(k.shift()):c?r=[]:e.disable())},e={add:function(){if(r){var a=r.length;(function ad(a){f.each(a,function(a,b){var q=f.type(b);"function"===q?(!g.unique||!e.has(b))&&r.push(b):b&&(b.length&&"string"!==q)&&ad(b)})})(arguments);j?n=r.length:c&&(h=a,l(c))}return this},remove:function(){r&&f.each(arguments,function(g,a){for(var b;-1<(b=f.inArray(a,r,b));)r.splice(b,1),j&&(b<=n&&n--,b<=p&&p--)});return this},has:function(g){return g?-1<f.inArray(g,
r):!(!r||!r.length)},empty:function(){r=[];n=0;return this},disable:function(){r=k=c=void 0;return this},disabled:function(){return!r},lock:function(){k=void 0;c||e.disable();return this},locked:function(){return!k},fireWith:function(g,a){if(r&&(!d||k))a=a||[],a=[g,a.slice?a.slice():a],j?k.push(a):l(a);return this},fire:function(){e.fireWith(this,arguments);return this},fired:function(){return!!d}};return e};f.extend({Deferred:function(g){var a=[["resolve","done",f.Callbacks("once memory"),"resolved"],
...
b.doScroll&&function Vc(){if(!f.isReady){try{b.doScroll("left")}catch(g){return setTimeout(Vc,50)}l();f.ready()}}()}return Ab.promise(g)};var ia="undefined",Ac;for(Ac in f(u))break;u.ownLast="0"!==Ac;u.inlineBlockNeedsLayout=!1;f(function(){var g,a,b=y.getElementsByTagName("body")[0];if(b){g=y.createElement("div");g.style.cssText="border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px";a=y.createElement("div");b.appendChild(g).appendChild(a);if(typeof a.style.zoom!==ia&&(a.style.cssText=
...
p();return c.promise(a)}});var Bb=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Oa=["Top","Right","Bottom","Left"],ib=function(a,b){a=b||a;return"none"===f.css(a,"display")||!f.contains(a.ownerDocument,a)},Ua=f.access=function(a,b,j,c,d,n,p){var h=0,r=a.length,k=null==j;if("object"===f.type(j))for(h in d=!0,j)f.access(a,b,h,j[h],!0,n,p);else if(void 0!==c&&(d=!0,f.isFunction(c)||(p=!0),k&&(p?(b.call(a,c),b=null):(k=b,b=function(a,g,b){return k.call(f(a),b)})),b))for(;h<r;h++)b(a[h],j,p?c:c.call(a[h],
h,b(a[h],j)));return d?a:k?b.call(a):r?b(a[0],j):n},Ob=/^(?:checkbox|radio)$/i,Yb=y.createDocumentFragment(),Z=y.createElement("div"),pb=y.createElement("input");Z.setAttribute("className","t");Z.innerHTML="  <link/><table></table><a href='/a'>a</a>";u.leadingWhitespace=3===Z.firstChild.nodeType;u.tbody=!Z.getElementsByTagName("tbody").length;u.htmlSerialize=!!Z.getElementsByTagName("link").length;u.html5Clone="<:nav></:nav>"!==y.createElement("nav").cloneNode(!0).outerHTML;pb.type="checkbox";pb.checked=
!0;Yb.appendChild(pb);u.appendChecked=pb.checked;Z.innerHTML="<textarea>x</textarea>";u.noCloneChecked=!!Z.cloneNode(!0).lastChild.defaultValue;Yb.appendChild(Z);Z.innerHTML="<input type='radio' checked='checked' name='t'/>";u.checkClone=Z.cloneNode(!0).cloneNode(!0).lastChild.checked;u.noCloneEvent=!0;Z.attachEvent&&(Z.attachEvent("onclick",function(){u.noCloneEvent=!1}),Z.cloneNode(!0).click());if(null==u.deleteExpando){u.deleteExpando=!0;try{delete Z.test}catch($d){u.deleteExpando=!1}}var Yb=Z=
pb=null,Cb,Db,Bc=y.createElement("div");for(Cb in{submit:!0,change:!0,focusin:!0})if(Db="on"+Cb,!(u[Cb+"Bubbles"]=Db in a))Bc.setAttribute(Db,"t"),u[Cb+"Bubbles"]=!1===Bc.attributes[Db].expando;var Zb=/^(?:input|select|textarea)$/i,wd=/^key/,xd=/^(?:mouse|contextmenu)|click/,Cc=/^(?:focusinfocus|focusoutblur)$/,Dc=/^([^.]*)(?:\.(.+)|)$/;f.event={global:{},add:function(a,b,j,c,d){var n,p,h,r,k,l,e,A,z;if(h=f._data(a)){j.handler&&(r=j,j=r.handler,d=r.selector);j.guid||(j.guid=f.guid++);if(!(p=h.events))p=
h.events={};if(!(k=h.handle))k=h.handle=function(a){return typeof f!==ia&&(!a||f.event.triggered!==a.type)?f.event.dispatch.apply(k.elem,arguments):void 0},k.elem=a;b=(b||"").match(va)||[""];for(h=b.length;h--;)if(n=Dc.exec(b[h])||[],A=l=n[1],z=(n[2]||"").split(".").sort(),A){n=f.event.special[A]||{};A=(d?n.delegateType:n.bindType)||A;n=f.event.special[A]||{};l=f.extend({type:A,origType:l,data:c,handler:j,guid:j.guid,selector:d,needsContext:d&&f.expr.match.needsContext.test(d),namespace:z.join(".")},
r);if(!(e=p[A]))if(e=p[A]=[],e.delegateCount=0,!n.setup||!1===n.setup.call(a,c,z,k))a.addEventListener?a.addEventListener(A,k,!1):a.attachEvent&&a.attachEvent("on"+A,k);n.add&&(n.add.call(a,l),l.handler.guid||(l.handler.guid=j.guid));d?e.splice(e.delegateCount++,0,l):e.push(l);f.event.global[A]=!0}a=null}},remove:function(a,b,j,c,d){var n,p,h,r,k,l,e,A,z,C,Ga,t=f.hasData(a)&&f._data(a);if(t&&(l=t.events)){b=(b||"").match(va)||[""];for(k=b.length;k--;)if(h=Dc.exec(b[k])||[],z=Ga=h[1],C=(h[2]||"").split(".").sort(),
z){e=f.event.special[z]||{};z=(c?e.delegateType:e.bindType)||z;A=l[z]||[];h=h[2]&&RegExp("(^|\\.)"+C.join("\\.(?:.*\\.|)")+"(\\.|$)");for(r=n=A.length;n--;)if(p=A[n],(d||Ga===p.origType)&&(!j||j.guid===p.guid)&&(!h||h.test(p.namespace))&&(!c||c===p.selector||"**"===c&&p.selector))A.splice(n,1),p.selector&&A.delegateCount--,e.remove&&e.remove.call(a,p);r&&!A.length&&((!e.teardown||!1===e.teardown.call(a,C,t.handle))&&f.removeEvent(a,z,t.handle),delete l[z])}else for(z in l)f.event.remove(a,z+b[k],
j,c,!0);f.isEmptyObject(l)&&(delete t.handle,f._removeData(a,"events"))}},trigger:function(g,b,j,c){var d,n,p,h,r,k,l=[j||y],e=Za.call(g,"type")?g.type:g;r=Za.call(g,"namespace")?g.namespace.split("."):[];p=d=j=j||y;if(!(3===j.nodeType||8===j.nodeType)&&!Cc.test(e+f.event.triggered))if(0<=e.indexOf(".")&&(r=e.split("."),e=r.shift(),r.sort()),n=0>e.indexOf(":")&&"on"+e,g=g[f.expando]?g:new f.Event(e,"object"===typeof g&&g),g.isTrigger=c?2:3,g.namespace=r.join("."),g.namespace_re=g.namespace?RegExp("(^|\\.)"+
r.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,g.result=void 0,g.target||(g.target=j),b=null==b?[g]:f.makeArray(b,[g]),r=f.event.special[e]||{},c||!(r.trigger&&!1===r.trigger.apply(j,b))){if(!c&&!r.noBubble&&!f.isWindow(j)){h=r.delegateType||e;Cc.test(h+e)||(p=p.parentNode);for(;p;p=p.parentNode)l.push(p),d=p;if(d===(j.ownerDocument||y))l.push(d.defaultView||d.parentWindow||a)}for(k=0;(p=l[k++])&&!g.isPropagationStopped();)if(g.type=1<k?h:r.bindType||e,(d=(f._data(p,"events")||{})[g.type]&&f._data(p,"handle"))&&
d.apply(p,b),(d=n&&p[n])&&d.apply&&f.acceptData(p))g.result=d.apply(p,b),!1===g.result&&g.preventDefault();g.type=e;if(!c&&!g.isDefaultPrevented()&&(!r._default||!1===r._default.apply(l.pop(),b))&&f.acceptData(j)&&n&&j[e]&&!f.isWindow(j)){(d=j[n])&&(j[n]=null);f.event.triggered=e;try{j[e]()}catch(A){}f.event.triggered=void 0;d&&(j[n]=d)}return g.result}},dispatch:function(a){a=f.event.fix(a);var b,j,c,d,n=[],h=p.call(arguments);b=(f._data(this,"events")||{})[a.type]||[];var r=f.event.special[a.type]||
{};h[0]=a;a.delegateTarget=this;if(!(r.preDispatch&&!1===r.preDispatch.call(this,a))){n=f.event.handlers.call(this,a,b);for(b=0;(c=n[b++])&&!a.isPropagationStopped();){a.currentTarget=c.elem;for(d=0;(j=c.handlers[d++])&&!a.isImmediatePropagationStopped();)if(!a.namespace_re||a.namespace_re.test(j.namespace))if(a.handleObj=j,a.data=j.data,j=((f.event.special[j.origType]||{}).handle||j.handler).apply(c.elem,h),void 0!==j&&!1===(a.result=j))a.preventDefault(),a.stopPropagation()}r.postDispatch&&r.postDispatch.call(this,
a);return a.result}},handlers:function(a,b){var j,c,d,n,p=[],h=b.delegateCount,r=a.target;if(h&&r.nodeType&&(!a.button||"click"!==a.type))for(;r!=this;r=r.parentNode||this)if(1===r.nodeType&&(!0!==r.disabled||"click"!==a.type)){d=[];for(n=0;n<h;n++)c=b[n],j=c.selector+" ",void 0===d[j]&&(d[j]=c.needsContext?0<=f(j,this).index(r):f.find(j,this,null,[r]).length),d[j]&&d.push(c);d.length&&p.push({elem:r,handlers:d})}h<b.length&&p.push({elem:this,handlers:b.slice(h)});return p},fix:function(a){if(a[f.expando])return a;
...
f&&f.clientLeft||0),a.pageY=b.clientY+(j&&j.scrollTop||f&&f.scrollTop||0)-(j&&j.clientTop||f&&f.clientTop||0));!a.relatedTarget&&d&&(a.relatedTarget=d===a.target?b.toElement:d);!a.which&&void 0!==c&&(a.which=c&1?1:c&2?3:c&4?2:0);return a}},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==D()&&this.focus)try{return this.focus(),!1}catch(a){}},delegateType:"focusin"},blur:{trigger:function(){if(this===D()&&this.blur)return this.blur(),!1},delegateType:"focusout"},click:{trigger:function(){if(f.nodeName(this,
...
f,!1)}:function(a,b,f){b="on"+b;a.detachEvent&&(typeof a[b]===ia&&(a[b]=null),a.detachEvent(b,f))};f.Event=function(a,b){if(!(this instanceof f.Event))return new f.Event(a,b);a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||void 0===a.defaultPrevented&&(!1===a.returnValue||a.getPreventDefault&&a.getPreventDefault())?r:C):this.type=a;b&&f.extend(this,b);this.timeStamp=a&&a.timeStamp||f.now();this[f.expando]=!0};f.Event.prototype={isDefaultPrevented:C,isPropagationStopped:C,
isImmediatePropagationStopped:C,preventDefault:function(){var a=this.originalEvent;this.isDefaultPrevented=r;a&&(a.preventDefault?a.preventDefault():a.returnValue=!1)},stopPropagation:function(){var a=this.originalEvent;this.isPropagationStopped=r;a&&(a.stopPropagation&&a.stopPropagation(),a.cancelBubble=!0)},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=r;this.stopPropagation()}};f.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){f.event.special[a]={delegateType:b,
...
Ic=/^$|\/(?:java|ecma)script/i,Zc=/^true\/(.*)/,Cd=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,ha={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],area:[1,"<map>","</map>"],param:[1,"<object>","</object>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:u.htmlSerialize?[0,"",""]:[1,"X<div>","</div>"]},ac=
T(y).appendChild(y.createElement("div"));ha.optgroup=ha.option;ha.tbody=ha.tfoot=ha.colgroup=ha.caption=ha.thead;ha.th=ha.td;f.extend({clone:function(a,b,j){var c,d,n,p,h,r=f.contains(a.ownerDocument,a);u.html5Clone||f.isXMLDoc(a)||!Ec.test("<"+a.nodeName+">")?n=a.cloneNode(!0):(ac.innerHTML=a.outerHTML,ac.removeChild(n=ac.firstChild));if((!u.noCloneEvent||!u.noCloneChecked)&&(1===a.nodeType||11===a.nodeType)&&!f.isXMLDoc(a)){c=P(n);h=P(a);for(p=0;null!=(d=h[p]);++p)if(c[p]){var k=c[p],e=void 0,l=
void 0,A=void 0;if(1===k.nodeType){e=k.nodeName.toLowerCase();if(!u.noCloneEvent&&k[f.expando]){A=f._data(k);for(l in A.events)f.removeEvent(k,l,A.handle);k.removeAttribute(f.expando)}if("script"===e&&k.text!==d.text)L(k).text=d.text,Q(k);else if("object"===e)k.parentNode&&(k.outerHTML=d.outerHTML),u.html5Clone&&(d.innerHTML&&!f.trim(k.innerHTML))&&(k.innerHTML=d.innerHTML);else if("input"===e&&Ob.test(d.type))k.defaultChecked=k.checked=d.checked,k.value!==d.value&&(k.value=d.value);else if("option"===
e)k.defaultSelected=k.selected=d.defaultSelected;else if("input"===e||"textarea"===e)k.defaultValue=d.defaultValue}}}if(b)if(j){h=h||P(a);c=c||P(n);for(p=0;null!=(d=h[p]);p++)Aa(d,c[p])}else Aa(a,n);c=P(n,"script");0<c.length&&Xa(c,!r&&P(a,"script"));return n},buildFragment:function(a,b,j,c){for(var d,n,p,h,r,k,e=a.length,l=T(b),A=[],z=0;z<e;z++)if((n=a[z])||0===n)if("object"===f.type(n))f.merge(A,n.nodeType?[n]:n);else if(zd.test(n)){p=p||l.appendChild(b.createElement("div"));h=(Gc.exec(n)||["",
""])[1].toLowerCase();k=ha[h]||ha._default;p.innerHTML=k[1]+n.replace(Fc,"<$1></$2>")+k[2];for(d=k[0];d--;)p=p.lastChild;!u.leadingWhitespace&&$b.test(n)&&A.push(b.createTextNode($b.exec(n)[0]));if(!u.tbody)for(d=(n="table"===h&&!Hc.test(n)?p.firstChild:"<table>"===k[1]&&!Hc.test(n)?p:0)&&n.childNodes.length;d--;)f.nodeName(r=n.childNodes[d],"tbody")&&!r.childNodes.length&&n.removeChild(r);f.merge(A,p.childNodes);for(p.textContent="";p.firstChild;)p.removeChild(p.firstChild);p=l.lastChild}else A.push(b.createTextNode(n));
p&&l.removeChild(p);u.appendChecked||f.grep(P(A,"input"),tb);for(z=0;n=A[z++];)if(!(c&&-1!==f.inArray(n,c))&&(a=f.contains(n.ownerDocument,n),p=P(l.appendChild(n),"script"),a&&Xa(p),j))for(d=0;n=p[d++];)Ic.test(n.type||"")&&j.push(n);return l},cleanData:function(a,b){for(var j,c,d,p,h=0,r=f.expando,k=f.cache,e=u.deleteExpando,l=f.event.special;null!=(j=a[h]);h++)if(b||f.acceptData(j))if(p=(d=j[r])&&k[d]){if(p.events)for(c in p.events)l[c]?f.event.remove(j,c):f.removeEvent(j,c,p.handle);k[d]&&(delete k[d],
e?delete j[r]:typeof j.removeAttribute!==ia?j.removeAttribute(r):j[r]=null,n.push(d))}}});f.fn.extend({text:function(a){return Ua(this,function(a){return void 0===a?f.text(this):this.empty().append((this[0]&&this[0].ownerDocument||y).createTextNode(a))},null,a,arguments.length)},append:function(){return this.domManip(arguments,function(a){(1===this.nodeType||11===this.nodeType||9===this.nodeType)&&Ma(this,a).appendChild(a)})},prepend:function(){return this.domManip(arguments,function(a){if(1===this.nodeType||
11===this.nodeType||9===this.nodeType){var b=Ma(this,a);b.insertBefore(a,b.firstChild)}})},before:function(){return this.domManip(arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this)})},after:function(){return this.domManip(arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},remove:function(a,b){for(var j,c=a?f.filter(a,this):this,d=0;null!=(j=c[d]);d++)!b&&1===j.nodeType&&f.cleanData(P(j)),j.parentNode&&(b&&f.contains(j.ownerDocument,
j)&&Xa(P(j,"script")),j.parentNode.removeChild(j));return this},empty:function(){for(var a,b=0;null!=(a=this[b]);b++){for(1===a.nodeType&&f.cleanData(P(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&f.nodeName(a,"select")&&(a.options.length=0)}return this},clone:function(a,b){a=null==a?!1:a;b=null==b?a:b;return this.map(function(){return f.clone(this,a,b)})},html:function(a){return Ua(this,function(a){var g=this[0]||{},b=0,j=this.length;if(void 0===a)return 1===g.nodeType?g.innerHTML.replace(yd,
""):void 0;if("string"===typeof a&&!Ad.test(a)&&(u.htmlSerialize||!Ec.test(a))&&(u.leadingWhitespace||!$b.test(a))&&!ha[(Gc.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(Fc,"<$1></$2>");try{for(;b<j;b++)g=this[b]||{},1===g.nodeType&&(f.cleanData(P(g,!1)),g.innerHTML=a);g=0}catch(c){}}g&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(){var a=arguments[0];this.domManip(arguments,function(b){a=this.parentNode;f.cleanData(P(this));a&&a.replaceChild(b,this)});return a&&(a.length||
a.nodeType)?this:this.remove()},detach:function(a){return this.remove(a,!0)},domManip:function(a,b){a=z.apply([],a);var j,c,d,n,p=0,h=this.length,r=this,k=h-1,e=a[0],l=f.isFunction(e);if(l||1<h&&"string"===typeof e&&!u.checkClone&&Bd.test(e))return this.each(function(j){var f=r.eq(j);l&&(a[0]=e.call(this,j,f.html()));f.domManip(a,b)});if(h&&(n=f.buildFragment(a,this[0].ownerDocument,!1,this),j=n.firstChild,1===n.childNodes.length&&(n=j),j)){d=f.map(P(n,"script"),L);for(c=d.length;p<h;p++)j=n,p!==
k&&(j=f.clone(j,!0,!0),c&&f.merge(d,P(j,"script"))),b.call(this[p],j,p);if(c){n=d[d.length-1].ownerDocument;f.map(d,Q);for(p=0;p<c;p++)if(j=d[p],Ic.test(j.type||"")&&!f._data(j,"globalEval")&&f.contains(n,j))j.src?f._evalUrl&&f._evalUrl(j.src):f.globalEval((j.text||j.textContent||j.innerHTML||"").replace(Cd,""))}n=j=null}return this}});f.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){f.fn[a]=function(a){for(var g=0,j=[],
c=f(a),d=c.length-1;g<=d;g++)a=g===d?this:this.clone(!0),f(c[g])[b](a),H.apply(j,a.get());return this.pushStack(j)}});var gb,nc={},qb,Eb,db=y.createElement("div");db.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>";qb=db.getElementsByTagName("a")[0];qb.style.cssText="float:left;opacity:.5";u.opacity=/^0.5/.test(qb.style.opacity);u.cssFloat=!!qb.style.cssFloat;db.style.backgroundClip="content-box";db.cloneNode(!0).style.backgroundClip="";u.clearCloneStyle="content-box"===
db.style.backgroundClip;qb=db=null;u.shrinkWrapBlocks=function(){var a,b,j;if(null==Eb){a=y.getElementsByTagName("body")[0];if(!a)return;b=y.createElement("div");j=y.createElement("div");a.appendChild(b).appendChild(j);Eb=!1;typeof j.style.zoom!==ia&&(j.style.cssText="-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0;width:1px;padding:1px;zoom:1",j.innerHTML="<div></div>",j.firstChild.style.width="5px",Eb=3!==j.offsetWidth);
a.removeChild(b)}return Eb};var Jc=/^margin/,ub=RegExp("^("+Bb+")(?!px)[a-z%]+$","i"),Pa,Qa,Dd=/^(top|right|bottom|left)$/;a.getComputedStyle?(Pa=function(a){return a.ownerDocument.defaultView.getComputedStyle(a,null)},Qa=function(a,b,j){var c,d,n=a.style;d=(j=j||Pa(a))?j.getPropertyValue(b)||j[b]:void 0;j&&(""===d&&!f.contains(a.ownerDocument,a)&&(d=f.style(a,b)),ub.test(d)&&Jc.test(b)&&(a=n.width,b=n.minWidth,c=n.maxWidth,n.minWidth=n.maxWidth=n.width=d,d=j.width,n.width=a,n.minWidth=b,n.maxWidth=
c));return void 0===d?d:d+""}):y.documentElement.currentStyle&&(Pa=function(a){return a.currentStyle},Qa=function(a,b,j){var f,c,d,n=a.style;d=(j=j||Pa(a))?j[b]:void 0;null==d&&(n&&n[b])&&(d=n[b]);if(ub.test(d)&&!Dd.test(b)){j=n.left;if(c=(f=a.runtimeStyle)&&f.left)f.left=a.currentStyle.left;n.left="fontSize"===b?"1em":d;d=n.pixelLeft+"px";n.left=j;c&&(f.left=c)}return void 0===d?d:d+""||"auto"});var dc=function(){var g,b,j=y.getElementsByTagName("body")[0];j&&(g=y.createElement("div"),b=y.createElement("div"),
g.style.cssText=bc,j.appendChild(g).appendChild(b),b.style.cssText="-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;display:block;padding:1px;border:1px;width:4px;margin-top:1%;top:1%",f.swap(j,null!=j.style.zoom?{zoom:1}:{},function(){cc=4===b.offsetWidth}),Fb=!0,Gb=!1,Hb=!0,a.getComputedStyle&&(Gb="1%"!==(a.getComputedStyle(b,null)||{}).top,Fb="4px"===(a.getComputedStyle(b,null)||{width:"4px"}).width),j.removeChild(g),b=j=null)},rb,Ib,cc,Fb,Gb,Hb,
eb=y.createElement("div"),bc="border:0;width:0;height:0;position:absolute;top:0;left:-9999px";eb.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>";rb=eb.getElementsByTagName("a")[0];rb.style.cssText="float:left;opacity:.5";u.opacity=/^0.5/.test(rb.style.opacity);u.cssFloat=!!rb.style.cssFloat;eb.style.backgroundClip="content-box";eb.cloneNode(!0).style.backgroundClip="";u.clearCloneStyle="content-box"===eb.style.backgroundClip;rb=eb=null;f.extend(u,{reliableHiddenOffsets:function(){if(null!=
...
8===a.nodeType||!a.style)){var d,n,p,h=f.camelCase(b),r=a.style;b=f.cssProps[h]||(f.cssProps[h]=ra(r,h));p=f.cssHooks[b]||f.cssHooks[h];if(void 0!==j){n=typeof j;if("string"===n&&(d=Gd.exec(j)))j=(d[1]+1)*d[2]+parseFloat(f.css(a,b)),n="number";if(!(null==j||j!==j))if("number"===n&&!f.cssNumber[h]&&(j+="px"),!u.clearCloneStyle&&(""===j&&0===b.indexOf("background"))&&(r[b]="inherit"),!p||!("set"in p)||void 0!==(j=p.set(a,j,c)))try{r[b]="",r[b]=j}catch(k){}}else return p&&"get"in p&&void 0!==(d=p.get(a,
!1,c))?d:r[b]}},css:function(a,b,j,c){var d,n;n=f.camelCase(b);b=f.cssProps[n]||(f.cssProps[n]=ra(a.style,n));(n=f.cssHooks[b]||f.cssHooks[n])&&"get"in n&&(d=n.get(a,!0,j));void 0===d&&(d=Qa(a,b,c));"normal"===d&&b in Kc&&(d=Kc[b]);return""===j||j?(a=parseFloat(d),!0===j||f.isNumeric(a)?a||0:d):d}});f.each(["height","width"],function(a,b){f.cssHooks[b]={get:function(a,g,j){if(g)return 0===a.offsetWidth&&Fd.test(f.css(a,"display"))?f.swap(a,Hd,function(){return ja(a,b,j)}):ja(a,b,j)},set:function(a,
g,j){var c=j&&Pa(a);return w(a,g,j?X(a,b,j,u.boxSizing()&&"border-box"===f.css(a,"boxSizing",!1,c),c):0)}}});u.opacity||(f.cssHooks.opacity={get:function(a,b){return Ed.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var j=a.style,c=a.currentStyle,d=f.isNumeric(b)?"alpha(opacity="+100*b+")":"",n=c&&c.filter||j.filter||"";j.zoom=1;if((1<=b||""===b)&&""===f.trim(n.replace(ec,""))&&j.removeAttribute)if(j.removeAttribute("filter"),
""===b||c&&!c.filter)return;j.filter=ec.test(n)?n.replace(ec,d):n+" "+d}});f.cssHooks.marginRight=Na(u.reliableMarginRight,function(a,b){if(b)return f.swap(a,{display:"inline-block"},Qa,[a,"marginRight"])});f.each({margin:"",padding:"",border:"Width"},function(a,b){f.cssHooks[a+b]={expand:function(j){var f=0,c={};for(j="string"===typeof j?j.split(" "):[j];4>f;f++)c[a+Oa[f]+b]=j[f]||j[f-2]||j[0];return c}};Jc.test(a)||(f.cssHooks[a+b].set=w)});f.fn.extend({css:function(a,b){return Ua(this,function(a,
g,b){var j,c={},d=0;if(f.isArray(g)){b=Pa(a);for(j=g.length;d<j;d++)c[g[d]]=f.css(a,g[d],!1,b);return c}return void 0!==b?f.style(a,g,b):f.css(a,g)},a,b,1<arguments.length)},show:function(){return hb(this,!0)},hide:function(){return hb(this)},toggle:function(a){return"boolean"===typeof a?a?this.show():this.hide():this.each(function(){ib(this)?f(this).show():f(this).hide()})}});f.Tween=G;G.prototype={constructor:G,init:function(a,b,j,c,d,n){this.elem=a;this.prop=j;this.easing=d||"swing";this.options=
b;this.start=this.now=this.cur();this.end=c;this.unit=n||(f.cssNumber[j]?"":"px")},cur:function(){var a=G.propHooks[this.prop];return a&&a.get?a.get(this):G.propHooks._default.get(this)},run:function(a){var b,j=G.propHooks[this.prop];this.pos=this.options.duration?b=f.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):b=a;this.now=(this.end-this.start)*b+this.start;this.options.step&&this.options.step.call(this.elem,this.now,this);j&&j.set?j.set(this):G.propHooks._default.set(this);
return this}};G.prototype.init.prototype=G.prototype;G.propHooks={_default:{get:function(a){if(null!=a.elem[a.prop]&&(!a.elem.style||null==a.elem.style[a.prop]))return a.elem[a.prop];a=f.css(a.elem,a.prop,"");return!a||"auto"===a?0:a},set:function(a){if(f.fx.step[a.prop])f.fx.step[a.prop](a);else a.elem.style&&(null!=a.elem.style[f.cssProps[a.prop]]||f.cssHooks[a.prop])?f.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=a.now}}};G.propHooks.scrollTop=G.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&
a.elem.parentNode&&(a.elem[a.prop]=a.now)}};f.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};f.fx=G.prototype.init;f.fx.step={};var Ya,Jb,Id=/^(?:toggle|show|hide)$/,Lc=RegExp("^(?:([+-])=|)("+Bb+")([a-z%]*)$","i"),Jd=/queueHooks$/,vb=[function(a,b,j){var c,d,n,p,h,r,k=this,e={},l=a.style,A=a.nodeType&&ib(a),z=f._data(a,"fxshow");j.queue||(p=f._queueHooks(a,"fx"),null==p.unqueued&&(p.unqueued=0,h=p.empty.fire,p.empty.fire=function(){p.unqueued||h()}),p.unqueued++,
k.always(function(){k.always(function(){p.unqueued--;f.queue(a,"fx").length||p.empty.fire()})}));if(1===a.nodeType&&("height"in b||"width"in b))j.overflow=[l.overflow,l.overflowX,l.overflowY],d=f.css(a,"display"),r=Ca(a.nodeName),"none"===d&&(d=r),"inline"===d&&"none"===f.css(a,"float")&&(!u.inlineBlockNeedsLayout||"inline"===r?l.display="inline-block":l.zoom=1);j.overflow&&(l.overflow="hidden",u.shrinkWrapBlocks()||k.always(function(){l.overflow=j.overflow[0];l.overflowX=j.overflow[1];l.overflowY=
j.overflow[2]}));for(c in b)if(d=b[c],Id.exec(d)){delete b[c];n=n||"toggle"===d;if(d===(A?"hide":"show"))if("show"===d&&z&&void 0!==z[c])A=!0;else continue;e[c]=z&&z[c]||f.style(a,c)}if(!f.isEmptyObject(e))for(c in z?"hidden"in z&&(A=z.hidden):z=f._data(a,"fxshow",{}),n&&(z.hidden=!A),A?f(a).show():k.done(function(){f(a).hide()}),k.done(function(){var b;f._removeData(a,"fxshow");for(b in e)f.style(a,b,e[b])}),e)b=jb(A?z[c]:0,c,k),c in z||(z[c]=b.start,A&&(b.end=b.start,b.start="width"===c||"height"===
c?1:0))}],kb={"*":[function(a,b){var j=this.createTween(a,b),c=j.cur(),d=Lc.exec(b),n=d&&d[3]||(f.cssNumber[a]?"":"px"),p=(f.cssNumber[a]||"px"!==n&&+c)&&Lc.exec(f.css(j.elem,a)),h=1,r=20;if(p&&p[3]!==n){n=n||p[3];d=d||[];p=+c||1;do h=h||".5",p/=h,f.style(j.elem,a,p+n);while(h!==(h=j.cur()/c)&&1!==h&&--r)}d&&(p=j.start=+p||+c||0,j.unit=n,j.end=d[1]?p+(d[1]+1)*d[2]:+d[2]);return j}]};f.Animation=f.extend(lb,{tweener:function(a,b){f.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var j,c=0,d=a.length;c<
d;c++)j=a[c],kb[j]=kb[j]||[],kb[j].unshift(b)},prefilter:function(a,b){b?vb.unshift(a):vb.push(a)}});f.speed=function(a,b,j){var c=a&&"object"===typeof a?f.extend({},a):{complete:j||!j&&b||f.isFunction(a)&&a,duration:a,easing:j&&b||b&&!f.isFunction(b)&&b};c.duration=f.fx.off?0:"number"===typeof c.duration?c.duration:c.duration in f.fx.speeds?f.fx.speeds[c.duration]:f.fx.speeds._default;if(null==c.queue||!0===c.queue)c.queue="fx";c.old=c.complete;c.complete=function(){f.isFunction(c.old)&&c.old.call(this);
c.queue&&f.dequeue(this,c.queue)};return c};f.fn.extend({fadeTo:function(a,b,j,f){return this.filter(ib).css("opacity",0).show().end().animate({opacity:b},a,j,f)},animate:function(a,b,j,c){var d=f.isEmptyObject(a),n=f.speed(b,j,c);b=function(){var b=lb(this,f.extend({},a),n);(d||f._data(this,"finish"))&&b.stop(!0)};b.finish=b;return d||!1===n.queue?this.each(b):this.queue(n.queue,b)},stop:function(a,b,j){var c=function(a){var b=a.stop;delete a.stop;b(j)};"string"!==typeof a&&(j=b,b=a,a=void 0);b&&
...
!0;f.queue(this,a,[]);b&&b.stop&&b.stop.call(this,!0);for(b=d.length;b--;)d[b].elem===this&&d[b].queue===a&&(d[b].anim.stop(!0),d.splice(b,1));for(b=0;b<n;b++)c[b]&&c[b].finish&&c[b].finish.call(this);delete j.finish})}});f.each(["toggle","show","hide"],function(a,b){var j=f.fn[b];f.fn[b]=function(a,g,f){return null==a||"boolean"===typeof a?j.apply(this,arguments):this.animate(ka(b,!0),a,g,f)}});f.each({slideDown:ka("show"),slideUp:ka("hide"),slideToggle:ka("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},
fadeToggle:{opacity:"toggle"}},function(a,b){f.fn[a]=function(a,g,j){return this.animate(b,a,g,j)}});f.timers=[];f.fx.tick=function(){var a,b=f.timers,j=0;for(Ya=f.now();j<b.length;j++)a=b[j],!a()&&b[j]===a&&b.splice(j--,1);b.length||f.fx.stop();Ya=void 0};f.fx.timer=function(a){f.timers.push(a);a()?f.fx.start():f.timers.pop()};f.fx.interval=13;f.fx.start=function(){Jb||(Jb=setInterval(f.fx.tick,f.fx.interval))};f.fx.stop=function(){clearInterval(Jb);Jb=null};f.fx.speeds={slow:600,fast:200,_default:400};
f.fn.delay=function(a,b){a=f.fx?f.fx.speeds[a]||a:a;return this.queue(b||"fx",function(b,j){var f=setTimeout(b,a);j.stop=function(){clearTimeout(f)}})};var Kb,Ja,fc,gc,sb=y.createElement("div");sb.setAttribute("className","t");sb.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>";Kb=sb.getElementsByTagName("a")[0];fc=y.createElement("select");gc=fc.appendChild(y.createElement("option"));Ja=sb.getElementsByTagName("input")[0];Kb.style.cssText="top:1px";u.getSetAttribute=
"t"!==sb.className;u.style=/top/.test(Kb.getAttribute("style"));u.hrefNormalized="/a"===Kb.getAttribute("href");u.checkOn=!!Ja.value;u.optSelected=gc.selected;u.enctype=!!y.createElement("form").enctype;fc.disabled=!0;u.optDisabled=!gc.disabled;Ja=y.createElement("input");Ja.setAttribute("value","");u.input=""===Ja.getAttribute("value");Ja.value="t";Ja.setAttribute("type","radio");u.radioValue="t"===Ja.value;var Kd=/\r/g;f.fn.extend({val:function(a){var b,j,c,d=this[0];if(arguments.length)return c=
...
n=f.makeArray(b),p=d.length;p--;)if(c=d[p],0<=f.inArray(f.valHooks.option.get(c),n))try{c.selected=j=!0}catch(h){c.scrollHeight}else c.selected=!1;j||(a.selectedIndex=-1);return d}}}});f.each(["radio","checkbox"],function(){f.valHooks[this]={set:function(a,b){if(f.isArray(b))return a.checked=0<=f.inArray(f(a).val(),b)}};u.checkOn||(f.valHooks[this].get=function(a){return null===a.getAttribute("value")?"on":a.value})});var fb,Mc,Ka=f.expr.attrHandle,hc=/^(?:checked|selected)$/i,Va=u.getSetAttribute,
Lb=u.input;f.fn.extend({attr:function(a,b){return Ua(this,f.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){f.removeAttr(this,a)})}});f.extend({attr:function(a,b,j){var c,d,n=a.nodeType;if(a&&!(3===n||8===n||2===n)){if(typeof a.getAttribute===ia)return f.prop(a,b,j);if(1!==n||!f.isXMLDoc(a))b=b.toLowerCase(),c=f.attrHooks[b]||(f.expr.match.bool.test(b)?Mc:fb);if(void 0!==j)if(null===j)f.removeAttr(a,b);else{if(c&&"set"in c&&void 0!==(d=c.set(a,j,b)))return d;a.setAttribute(b,
j+"");return j}else{if(c&&"get"in c&&null!==(d=c.get(a,b)))return d;d=f.find.attr(a,b);return null==d?void 0:d}}},removeAttr:function(a,b){var j,c,d=0,n=b&&b.match(va);if(n&&1===a.nodeType)for(;j=n[d++];)c=f.propFix[j]||j,f.expr.match.bool.test(j)?Lb&&Va||!hc.test(j)?a[c]=!1:a[f.camelCase("default-"+j)]=a[c]=!1:f.attr(a,j,""),a.removeAttribute(Va?j:c)},attrHooks:{type:{set:function(a,b){if(!u.radioValue&&"radio"===b&&f.nodeName(a,"input")){var j=a.value;a.setAttribute("type",b);j&&(a.value=j);return b}}}}});
Mc={set:function(a,b,j){!1===b?f.removeAttr(a,j):Lb&&Va||!hc.test(j)?a.setAttribute(!Va&&f.propFix[j]||j,j):a[f.camelCase("default-"+j)]=a[j]=!0;return j}};f.each(f.expr.match.bool.source.match(/\w+/g),function(a,b){var j=Ka[b]||f.find.attr;Ka[b]=Lb&&Va||!hc.test(b)?function(a,b,g){var c,f;g||(f=Ka[b],Ka[b]=c,c=null!=j(a,b,g)?b.toLowerCase():null,Ka[b]=f);return c}:function(a,b,g){if(!g)return a[f.camelCase("default-"+b)]?b.toLowerCase():null}});if(!Lb||!Va)f.attrHooks.value={set:function(a,b,j){if(f.nodeName(a,
"input"))a.defaultValue=b;else return fb&&fb.set(a,b,j)}};Va||(fb={set:function(a,b,j){var c=a.getAttributeNode(j);c||a.setAttributeNode(c=a.ownerDocument.createAttribute(j));c.value=b+="";if("value"===j||b===a.getAttribute(j))return b}},Ka.id=Ka.name=Ka.coords=function(a,b,j){var c;if(!j)return(c=a.getAttributeNode(b))&&""!==c.value?c.value:null},f.valHooks.button={get:function(a,b){var j=a.getAttributeNode(b);if(j&&j.specified)return j.value},set:fb.set},f.attrHooks.contenteditable={set:function(a,
b,j){fb.set(a,""===b?!1:b,j)}},f.each(["width","height"],function(a,b){f.attrHooks[b]={set:function(a,g){if(""===g)return a.setAttribute(b,"auto"),g}}}));u.style||(f.attrHooks.style={get:function(a){return a.style.cssText||void 0},set:function(a,b){return a.style.cssText=b+""}});var Ld=/^(?:input|select|textarea|button|object)$/i,Md=/^(?:a|area)$/i;f.fn.extend({prop:function(a,b){return Ua(this,f.prop,a,b,1<arguments.length)},removeProp:function(a){a=f.propFix[a]||a;return this.each(function(){try{this[a]=
...
j.getElementsByTagName("parsererror").length)&&f.error("Invalid XML: "+b);return j};var Wa,La,Od=/#.*$/,Nc=/([?&])_=[^&]*/,Pd=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Qd=/^(?:GET|HEAD)$/,Rd=/^\/\//,Oc=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,Pc={},Pb={},Qc="*/".concat("*");try{La=location.href}catch(ae){La=y.createElement("a"),La.href="",La=La.href}Wa=Oc.exec(La.toLowerCase())||[];f.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:La,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Wa[1]),
global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Qc,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":f.parseJSON,"text xml":f.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?la(la(a,
f.ajaxSettings),b):la(f.ajaxSettings,a)},ajaxPrefilter:wb(Pc),ajaxTransport:wb(Pb),ajax:function(a,b){function j(a,b,g,c){var d,l,q,m;m=b;if(2!==ca){ca=2;h&&clearTimeout(h);k=void 0;p=c||"";s.readyState=0<a?4:0;c=200<=a&&300>a||304===a;if(g){q=e;for(var v=s,O,qa,D,I,H=q.contents,x=q.dataTypes;"*"===x[0];)x.shift(),void 0===qa&&(qa=q.mimeType||v.getResponseHeader("Content-Type"));if(qa)for(I in H)if(H[I]&&H[I].test(qa)){x.unshift(I);break}if(x[0]in g)D=x[0];else{for(I in g){if(!x[0]||q.converters[I+
" "+x[0]]){D=I;break}O||(O=I)}D=D||O}D?(D!==x[0]&&x.unshift(D),q=g[D]):q=void 0}a:{g=e;O=q;qa=s;D=c;var cb,u,T,v={},H=g.dataTypes.slice();if(H[1])for(u in g.converters)v[u.toLowerCase()]=g.converters[u];for(I=H.shift();I;)if(g.responseFields[I]&&(qa[g.responseFields[I]]=O),!T&&(D&&g.dataFilter)&&(O=g.dataFilter(O,g.dataType)),T=I,I=H.shift())if("*"===I)I=T;else if("*"!==T&&T!==I){u=v[T+" "+I]||v["* "+I];if(!u)for(cb in v)if(q=cb.split(" "),q[1]===I&&(u=v[T+" "+q[0]]||v["* "+q[0]])){!0===u?u=v[cb]:
!0!==v[cb]&&(I=q[0],H.unshift(q[1]));break}if(!0!==u)if(u&&g["throws"])O=u(O);else try{O=u(O)}catch(ea){q={state:"parsererror",error:u?ea:"No conversion from "+T+" to "+I};break a}}q={state:"success",data:O}}if(c)e.ifModified&&((m=s.getResponseHeader("Last-Modified"))&&(f.lastModified[n]=m),(m=s.getResponseHeader("etag"))&&(f.etag[n]=m)),204===a||"HEAD"===e.type?m="nocontent":304===a?m="notmodified":(m=q.state,d=q.data,l=q.error,c=!l);else if(l=m,a||!m)m="error",0>a&&(a=0);s.status=a;s.statusText=
(b||m)+"";c?C.resolveWith(A,[d,m,s]):C.rejectWith(A,[s,m,l]);s.statusCode(t);t=void 0;r&&z.trigger(c?"ajaxSuccess":"ajaxError",[s,e,c?d:l]);Ga.fireWith(A,[s,m]);r&&(z.trigger("ajaxComplete",[s,e]),--f.active||f.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var c,d,n,p,h,r,k,l,e=f.ajaxSetup({},b),A=e.context||e,z=e.context&&(A.nodeType||A.jquery)?f(A):f.event,C=f.Deferred(),Ga=f.Callbacks("once memory"),t=e.statusCode||{},m={},O={},ca=0,qa="canceled",s={readyState:0,getResponseHeader:function(a){var b;
if(2===ca){if(!l)for(l={};b=Pd.exec(p);)l[b[1].toLowerCase()]=b[2];b=l[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===ca?p:null},setRequestHeader:function(a,b){var j=a.toLowerCase();ca||(a=O[j]=O[j]||a,m[a]=b);return this},overrideMimeType:function(a){ca||(e.mimeType=a);return this},statusCode:function(a){var b;if(a)if(2>ca)for(b in a)t[b]=[t[b],a[b]];else s.always(a[s.status]);return this},abort:function(a){a=a||qa;k&&k.abort(a);j(0,a);return this}};C.promise(s).complete=
Ga.add;s.success=s.done;s.error=s.fail;e.url=((a||e.url||La)+"").replace(Od,"").replace(Rd,Wa[1]+"//");e.type=b.method||b.type||e.method||e.type;e.dataTypes=f.trim(e.dataType||"*").toLowerCase().match(va)||[""];null==e.crossDomain&&(c=Oc.exec(e.url.toLowerCase()),e.crossDomain=!(!c||!(c[1]!==Wa[1]||c[2]!==Wa[2]||(c[3]||("http:"===c[1]?"80":"443"))!==(Wa[3]||("http:"===Wa[1]?"80":"443")))));e.data&&(e.processData&&"string"!==typeof e.data)&&(e.data=f.param(e.data,e.traditional));mb(Pc,e,b,s);if(2===
ca)return s;(r=e.global)&&0===f.active++&&f.event.trigger("ajaxStart");e.type=e.type.toUpperCase();e.hasContent=!Qd.test(e.type);n=e.url;e.hasContent||(e.data&&(n=e.url+=(kc.test(n)?"&":"?")+e.data,delete e.data),!1===e.cache&&(e.url=Nc.test(n)?n.replace(Nc,"$1_="+jc++):n+(kc.test(n)?"&":"?")+"_="+jc++));e.ifModified&&(f.lastModified[n]&&s.setRequestHeader("If-Modified-Since",f.lastModified[n]),f.etag[n]&&s.setRequestHeader("If-None-Match",f.etag[n]));(e.data&&e.hasContent&&!1!==e.contentType||b.contentType)&&
s.setRequestHeader("Content-Type",e.contentType);s.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+("*"!==e.dataTypes[0]?", "+Qc+"; q=0.01":""):e.accepts["*"]);for(d in e.headers)s.setRequestHeader(d,e.headers[d]);if(e.beforeSend&&(!1===e.beforeSend.call(A,s,e)||2===ca))return s.abort();qa="abort";for(d in{success:1,error:1,complete:1})s[d](e[d]);if(k=mb(Pb,e,b,s)){s.readyState=1;r&&z.trigger("ajaxSend",[s,e]);e.async&&0<e.timeout&&(h=setTimeout(function(){s.abort("timeout")},
e.timeout));try{ca=1,k.send(m,j)}catch(D){if(2>ca)j(-1,D);else throw D;}}else j(-1,"No Transport");return s},getJSON:function(a,b,j){return f.get(a,b,j,"json")},getScript:function(a,b){return f.get(a,void 0,b,"script")}});f.each(["get","post"],function(a,b){f[b]=function(a,j,g,c){f.isFunction(j)&&(c=c||g,g=j,j=void 0);return f.ajax({url:a,type:b,dataType:c,data:j,success:g})}});f.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){f.fn[b]=function(a){return this.on(b,
...
this.value)});else for(j in a)B(j,a[j],b,d);return c.join("&").replace(Sd,"+")};f.fn.extend({serialize:function(){return f.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var a=f.prop(this,"elements");return a?f.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!f(this).is(":disabled")&&Ud.test(this.nodeName)&&!Td.test(a)&&(this.checked||!Ob.test(a))}).map(function(a,b){var j=f(this).val();return null==j?null:f.isArray(j)?f.map(j,function(a){return{name:b.name,
value:a.replace(Rc,"\r\n")}}):{name:b.name,value:j.replace(Rc,"\r\n")}}).get()}});f.ajaxSettings.xhr=void 0!==a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&/^(get|post|head|put|delete|options)$/i.test(this.type)&&$()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(j){}b=void 0}return b}:$;f.ajaxSettings.xhr=void 0===a.ActiveXObject?V:function(){return(this.url==y.location||0==this.url.indexOf("http")||!this.isLocal)&&/^(get|post|head|put|delete|options)$/i.test(this.type)&&
V()||V(1)};var Vd=0,Mb={},Nb=f.ajaxSettings.xhr();if(a.ActiveXObject)f(a).on("unload",function(){for(var a in Mb)Mb[a](void 0,!0)});u.cors=!!Nb&&"withCredentials"in Nb;(Nb=u.ajax=!!Nb)&&f.ajaxTransport(function(a){if(!a.crossDomain||u.cors){var b;return{send:function(j,c){var d,n=a.xhr(),p=++Vd;console.log("xhr.open async="+a.async+" url="+a.url);n.open(a.type,a.url,a.async,a.username,a.password);if(a.xhrFields)for(d in a.xhrFields)n[d]=a.xhrFields[d];a.mimeType&&n.overrideMimeType&&n.overrideMimeType(a.mimeType);
!a.crossDomain&&!j["X-Requested-With"]&&(j["X-Requested-With"]="XMLHttpRequest");for(d in j)void 0!==j[d]&&n.setRequestHeader(d,j[d]+"");n.send(a.hasContent&&a.data||null);b=function(j,d){var h,r,e;if(b&&(d||4===n.readyState))if(delete Mb[p],b=void 0,n.onreadystatechange=f.noop,d)4!==n.readyState&&n.abort();else{e={};h=n.status;"string"===typeof n.responseText&&(e.text=n.responseText);try{r=n.statusText}catch(k){r=""}!h&&a.isLocal&&!a.crossDomain?h=e.text?200:404:1223===h&&(h=204)}e&&c(h,r,e,n.getAllResponseHeaders())};
...
Uc})}});f.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var c=/Y/.test(b);f.fn[a]=function(d){return Ua(this,function(a,g,d){var n=j(a);if(void 0===d)return n?b in n?n[b]:n.document.documentElement[g]:a[g];n?n.scrollTo(!c?d:f(n).scrollLeft(),c?d:f(n).scrollTop()):a[g]=d},a,d,arguments.length,null)}});f.each(["top","left"],function(a,b){f.cssHooks[b]=Na(u.pixelPosition,function(a,j){if(j)return j=Qa(a,b),ub.test(j)?f(a).position()[b]+"px":j})});f.each({Height:"height",Width:"width"},
function(a,b){f.each({padding:"inner"+a,content:b,"":"outer"+a},function(j,c){f.fn[c]=function(c,d){var n=arguments.length&&(j||"boolean"!==typeof c),p=j||(!0===c||!0===d?"margin":"border");return Ua(this,function(b,j,c){return f.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(j=b.documentElement,Math.max(b.body["scroll"+a],j["scroll"+a],b.body["offset"+a],j["offset"+a],j["client"+a])):void 0===c?f.css(b,j,p):f.style(b,j,c,p)},b,n?c:void 0,n,null)}})});f.fn.size=function(){return this.length};
f.fn.andSelf=f.fn.addBack;"function"===typeof define&&define.amd&&define("jquery",[],function(){return f});var Wd=a.jQuery,Xd=a.$;f.noConflict=function(b){a.$===f&&(a.$=Xd);b&&a.jQuery===f&&(a.jQuery=Wd);return f};typeof m===ia&&(a.jQuery=a.$=f);return f});
...
var m=!1;try{t.hasOwnProperty("responseType")&&(t.responseType="arraybuffer",m=!0)}catch(b){}try{!m&&t.overrideMimeType&&t.overrideMimeType("text/plain; charset=x-user-defined")}catch(d){}!a.crossDomain&&!h["X-Requested-With"]&&(h["X-Requested-With"]="XMLHttpRequest");try{for(var c in h)t.setRequestHeader(c,h[c])}catch(r){}t.send(a.hasContent&&a.data||null);e=function(){var b=t.status,c="",d=t.getAllResponseHeaders(),h={};try{if(e&&4===t.readyState){e=void 0;try{h.text="string"===typeof t.responseText?
t.responseText:null}catch(r){}try{h.binary=t.response}catch(m){}try{c=t.statusText}catch(s){c=""}!b&&a.isLocal&&!a.crossDomain?b=h.text?200:404:1223===b&&(b=204);l(b,c,h,d)}}catch(Q){alert(Q),l(-1,Q)}};a.async?4===t.readyState?setTimeout(e):t.onreadystatechange=e:e()},abort:function(){}}}))})(jQuery);
(function(a,m,k,e){function h(h,k){function s(c){a(b).each(function(){self.Jmol&&(0<=k.indexOf("mouseup")||0<=k.indexOf("touchend"))&&Jmol._setMouseOwner(null);var b=a(this);this!==c.target&&!b.has(c.target).length&&b.triggerHandler(k,[c.target,c])})}k=k||h+e;var b=a(),d=h+"."+k+"-special-event";a.event.special[k]={setup:function(){b=b.add(this);1===b.length&&a(m).bind(d,s)},teardown:function(){self.Jmol&&Jmol._setMouseOwner(null);b=b.not(this);0===b.length&&a(m).unbind(d)},add:function(a){var b=
...
Jmol._version||(Jmol=function(a){var m=function(a){return{rear:a++,header:a++,main:a++,image:a++,front:a++,fileOpener:a++,coverImage:a++,dialog:a++,menu:a+9E4,console:a+91E3,consoleImage:a+91001,monitorZIndex:a+99999}},m={_version:"$Date: 2015-07-07 14:00:27 -0500 (Tue, 07 Jul 2015) $",_alertNoBinary:!0,_allowedJmolSize:[25,2048,300],_appletCssClass:"",_appletCssText:"",_fileCache:null,_jarFile:null,_j2sPath:null,_use:null,_j2sLoadMonitorOpacity:90,_applets:{},_asynchronous:!0,_ajaxQueue:[],_persistentMenu:!1,
...
(function(a,m){m(document).ready(function(){a._document=null});a.$=function(a,d){null==a&&alert(d+arguments.callee.caller.toString());return m(d?"#"+a._id+"_"+d:a)};a._$=function(a){return"string"==typeof a?m("#"+a):a};a.$ajax=function(b){a._ajaxCall=b.url;b.cache="NO"!=b.cache;0==b.url.indexOf("http://pubchem.ncbi.nlm.nih")&&(b.url="https://"+b.url.substring(7));return m.ajax(b)};a._getNCIInfo=function(b,d){return a._getFileData("http://cactus.nci.nih.gov/chemical/structure/"+b+"/"+("name"==d?"names":
d))};a.$appEvent=function(b,d,c,h){b=a.$(b,d);b.off(c)&&h&&b.on(c,h)};a.$resize=function(a){return m(window).resize(a)};a.$after=function(a,d){return m(a).after(d)};a.$append=function(a,d){return m(a).append(d)};a.$bind=function(a,d,c){return c?m(a).bind(d,c):m(a).unbind(d)};a.$closest=function(a,d){return m(a).closest(d)};a.$get=function(a,d){return m(a).get(d)};a.$documentOff=function(a,d){return m(document).off(a,"#"+d)};a.$documentOn=function(a,d,c){return m(document).on(a,"#"+d,c)};a.$getAncestorDiv=
function(a,d){return m("div."+d+":has(#"+a+")")[0]};a.$supportsIECrossDomainScripting=function(){return m.support.iecors};a.$attr=function(b,d,c){return a._$(b).attr(d,c)};a.$css=function(b,d){return a._$(b).css(d)};a.$find=function(b,d){return a._$(b).find(d)};a.$focus=function(b){return a._$(b).focus()};a.$html=function(b,d){return a._$(b).html(d)};a.$offset=function(b){return a._$(b).offset()};a.$windowOn=function(a,d){return m(window).on(a,d)};a.$prop=function(b,d,c){var h=a._$(b);return 3==arguments.length?
h.prop(d,c):h.prop(d)};a.$remove=function(b){return a._$(b).remove()};a.$scrollTo=function(b,d){var c=a._$(b);return c.scrollTop(0>d?c[0].scrollHeight:d)};a.$setEnabled=function(b,d){return a._$(b).attr("disabled",d?null:"disabled")};a.$getSize=function(b){b=a._$(b);return[b.width(),b.height()]};a.$setSize=function(b,d,c){return a._$(b).width(d).height(c)};a.$setVisible=function(b,d){var c=a._$(b);return d?c.show():c.hide()};a.$submit=function(b){return a._$(b).submit()};a.$val=function(b,d){var c=
a._$(b);return 1==arguments.length?c.val():c.val(d)};a._clearVars=function(){delete jQuery;delete m;delete a;delete SwingController;delete J;delete JM;delete JS;delete JSV;delete JU;delete JV;delete java;delete javajs;delete Clazz;delete c$};var k=document,e=window,h={};h.ua=navigator.userAgent.toLowerCase();var l;a:{l=["linux","unix","mac","win"];for(var t=l.length;t--;)if(-1!=h.ua.indexOf(l[t])){l=l[t];break a}l="unknown"}h.os=l;h.browser=function(){for(var a=h.ua,d="konqueror webkit omniweb opera webtv icab msie mozilla".split(" "),
...
--d;)if(0<=b.indexOf(a._binaryTypes[d]))return!0;return!1};a._getFileData=function(b,d,c){var h=a._isBinaryUrl(b),e=0<=b.indexOf("pdb.gz")&&0==b.indexOf("http://www.rcsb.org/pdb/files/"),k=h&&!a._canSyncBinary(e);k&&e&&(b=b.replace(/pdb\.gz/,"pdb"),k=h=!1);e=0<=b.indexOf("?POST?");0==b.indexOf("file:/")&&0!=b.indexOf("file:///")&&(b="file://"+b.substring(5));var l=0>b.indexOf("://")||0==b.indexOf(document.location.protocol)&&0<=b.indexOf(document.location.host),m=a._isDirectCall(b),t=!l&&a.$supportsIECrossDomainScripting(),
s=null;if((!d||k)&&(t||k||!l&&!m))s=a._getRawDataFromServer("_",b,d,d,k,!0);else{b=b.replace(/file:\/\/\/\//,"file://");var L={dataType:h?"binary":"text",async:!!d};e?(L.type="POST",L.url=b.split("?POST?")[0],L.data=b.split("?POST?")[1]):(L.type="GET",L.url=b);d&&(L.success=function(){d(a._xhrReturn(L.xhr))},L.error=function(){d(L.xhr.statusText)});L.xhr=a.$ajax(L);d||(s=a._xhrReturn(L.xhr))}if(!c)return s;null==s&&(s="",h=!1);h&&(h=a._canSyncBinary(!0));return h?a._strToBytes(s):JU.SB.newS(s)};a._xhrReturn=
function(a){return!a.responseText||self.Clazz&&Clazz.instanceOf(a.response,self.ArrayBuffer)?a.response||a.statusText:a.responseText};a._isDirectCall=function(b){for(var d in a.db._DirectDatabaseCalls)if(0<=d.indexOf(".")&&0<=b.indexOf(d))return!0;return!1};a._cleanFileData=function(a){return 0<=a.indexOf("\r")&&0<=a.indexOf("\n")?a.replace(/\r\n/g,"\n"):0<=a.indexOf("\r")?a.replace(/\r/g,"\n"):a};a._getFileType=function(a){var d=a.substring(0,1);if("$"==d||":"==d)return"MOL";if("="==d)return"="==
a.substring(1,2)?"LCIF":"PDB";a=a.split(".").pop().toUpperCase();return a.substring(0,Math.min(a.length,3))};a._getZ=function(b,d){return b&&b._z&&b._z[d]||a._z[d]};a._incrZ=function(b,d){return b&&b._z&&++b._z[d]||++a._z[d]};a._loadFileAsynchronously=function(b,d,c,h){if(0!=c.indexOf("?")){var e=c;c=a._checkFileName(d,c);var k=function(d){a._setData(b,c,e,d,h)},k=a._checkCache(d,c,k);0<=c.indexOf("|")&&(c=c.split("|")[0]);return null==k?null:a._getFileData(c,k)}if(!a.featureDetection.hasFileReader)return b.setData("Local file reading is not enabled in your browser",
null,null,h);d._localReader||(k='<div id="ID" style="z-index:'+a._getZ(d,"fileOpener")+';position:absolute;background:#E0E0E0;left:10px;top:10px"><div style="margin:5px 5px 5px 5px;"><input type="file" id="ID_files" /><button id="ID_loadfile">load</button><button id="ID_cancel">cancel</button></div><div>',a.$after("#"+d._id+"_appletdiv",k.replace(/ID/g,d._id+"_localReader")),d._localReader=a.$(d,"localReader"));a.$appEvent(d,"localReader_loadfile","click");a.$appEvent(d,"localReader_loadfile","click",
function(){var c=a.$(d,"localReader_files")[0].files[0],e=new FileReader;e.onloadend=function(e){e.target.readyState==FileReader.DONE&&(a.$css(a.$(d,"localReader"),{display:"none"}),a._setData(b,c.name,c.name,e.target.result,h))};e.readAsArrayBuffer(c)});a.$appEvent(d,"localReader_cancel","click");a.$appEvent(d,"localReader_cancel","click",function(){a.$css(a.$(d,"localReader"),{display:"none"});b.setData(null,null,null,h)});a.$css(a.$(d,"localReader"),{display:"block"})};a._setData=function(b,d,
c,h,e){h=a._strToBytes(h);0<=d.indexOf(".jdx")&&a.Cache.put("cache://"+d,h);b.setData(d,c,h,e)};a._toBytes=function(a){if("string"==typeof a)return a.getBytes();a=new Uint8Array(a);for(var d=Clazz.newByteArray(a.length,0),c=a.length;0<=--c;)d[c]=a[c];return d};a._doAjax=function(b,d,c){b=b.toString();if(null!=c)return a._saveFile(b,c);d&&(b+="?POST?"+d);return a._getFileData(b,null,!0)};a._saveFile=function(b,d,c,h){if(a._localFileSaveFunction&&a._localFileSaveFunction(b,d))return"OK";b=b.substring(b.lastIndexOf("/")+
1);c||(c=0<=b.indexOf(".pdf")?"application/pdf":0<=b.indexOf(".png")?"image/png":0<=b.indexOf(".gif")?"image/gif":0<=b.indexOf(".jpg")?"image/jpg":"");var e="string"==typeof d;e||(d=(JU?JU:J.util).Base64.getBase64(d).toString());h||(h=e?"":"base64");(e=a._serverUrl)&&0<=e.indexOf("your.server")&&(e="");a._useDataURI||!e?(h||(d=btoa(d)),h=document.createElement("a"),h.href="data:"+c+";base64,"+d,h.type=c||"text/plain",h.download=b,h.target="_blank",m("body").append(h),h.click(),h.remove()):(a._formdiv||
...
"__jsmolform__"),a.$attr(a._formdiv,"action",e+"?"+(new Date).getMilliseconds()),a.$val("__jsmoldata__",d),a.$val("__jsmolfilename__",b),a.$val("__jsmolmimetype__",c),a.$val("__jsmolencoding__",h),a.$submit("__jsmolform__"),a.$val("__jsmoldata__",""),a.$val("__jsmolfilename__",""));return"OK"};a._strToBytes=function(b){if(Clazz.instanceOf(b,self.ArrayBuffer))return a._toBytes(b);for(var d=Clazz.newByteArray(b.length,0),c=b.length;0<=--c;)d[c]=b.charCodeAt(c)&255;return d};a._setConsoleDiv=function(a){self.Clazz&&
Clazz.setConsoleDiv(a)};a._registerApplet=function(b,d){return window[b]=a._applets[b]=a._applets[d]=a._applets[b+"__"+a._syncId+"__"]=d};a._readyCallback=function(b,d,c,h,e){b=b.split("_object")[0];e||(e=h);c=c.booleanValue?c.booleanValue():c;var k=a._applets[b];k._appletPanel=e;k._applet=h;a._track(k._readyCallback(b,d,c))};a._getWrapper=function(b,d){var c;if(d){var h="";b._coverImage&&(h=' onclick="Jmol.coverApplet(ID, false)" title="'+b._coverTitle+'"',c='<image id="ID_coverclickgo" src="'+b._j2sPath+
...
a._setMouseOwner(null);if(b){var c=this;this.container.bind("mousemoveoutjsmol touchmoveoutjsmol",function(a,b,d){c.mouseMove(d)});this.container.bind("mouseupoutjsmol touchendoutjsmol",function(a,b,d){c.mouseUp(d)})}})};s.JSDialog=function(){};s.setDraggable(s.JSDialog);s.getScreenDimensions=function(a){a.width=m(window).width();a.height=m(window).height()};s.dispose=function(b){a.$remove(b.id+"_mover");delete s.htDialogs[b.id];b.container.obj.dragBind(!1)};s.register=function(a,d){a.id=d+ ++s.count;
...
function(a,b,h){for(var e in a)if("info"!=e){var k=a[e],l=k.applet,m=h||null!=l&&"<modified>"==l._molData;if(!(null==l||l==b&&!m)){var t=null==k.data,s=null!=l._currentView;l._currentView=a;if(!s||!(a[e].data==k.data&&!t&!m))if(l._loadModelFromView(a),t)break}}}})(a.View);a.Cache={fileCache:{}};a.Cache.get=function(b){return a.Cache.fileCache[b]};a.Cache.put=function(b,d){a.Cache.fileCache[b]=d};a.Cache.setDragDrop=function(b){a.$appEvent(b,"appletdiv","dragover",function(a){a=a.originalEvent;a.stopPropagation();
...
(function(a){a._isAsync=!1;a._asyncCallbacks={};a._coreFiles=[];var m=!1,k=[],e=[],h=0,l=[],t=[],s=function(b){arguments.length||(b=!0);delete h;for(var d;0<e.length&&"done"==(d=e[0])[4];)e.shift();if(0!=e.length)if(!a._isAsync&&!b)setTimeout(s,10);else{d.push("done");var l="JSmol exec "+d[0]._id+" "+d[3]+" "+d[2];self.System&&System.out.println(l);self.console&&console.log(l+" -- OK");k.push(l);d[1](d[0],d[2])}},b=function(b){m?s():(m=!0,LoadClazz(),b._noMonitor&&(Clazz._LoaderProgressMonitor.showStatus=
function(){}),LoadClazz=null,b.__Info.uncompressed&&Clazz.loadClass(),Clazz._Loader.onGlobalLoaded=function(){Clazz._LoaderProgressMonitor.showStatus("Application loaded.",!0);if(!a._debugCode||!a.haveCore)a.haveCore=!0,s()},Clazz._Loader.loadPackageClasspath("java",null,!0,s))},d=function(a,b){Clazz._Loader.loadClass(b,function(){s()})};a.showExecLog=function(){return k.join("\n")};a._addExec=function(a){a[1]||(a[1]=d);var b="JSmol load "+a[0]._id+" "+a[3];self.console&&console.log(b+"...");k.push(b);
...
"normal async abort from ":"")+e);return}b._jsSetScreenDimensions();s()};c._restoreState||(c._restoreState=function(){});c._jsSetScreenDimensions=function(){if(this._appletPanel){var b=a._getElement(this,this._is2D?"canvas2d":"canvas");this._appletPanel.setScreenDimension(b.width,b.height)}};c._show=function(b){a.$setVisible(a.$(this,"appletdiv"),b);b&&a._repaint(this,!0)};c._canScript=function(){return!0};c.equals=function(a){return this==a};c.clone=function(){return this};c.hashCode=function(){return parseInt(this._uniqueId)};
...
m);l.src="string"==typeof e?e:"data:"+JU.Rdr.guessMimeTypeForBytes(e)+";base64,"+JU.Base64.getBase64(e)}var s=l.width,Q=l.height;"webgl"==d&&(s/=2,Q/=2);t=a._getHiddenCanvas(b.vwr.html5Applet,m,s,Q,!0,!1);t.imageWidth=s;t.imageHeight=Q;t.id=m;t.image=l;a._setCanvasImage(t,s,Q,l.width,l.height)}else System.out.println("Jsmol.js Jmol._loadImage reading cached image for "+m);return null==e?k(t,h):t};a._canvasCache={};a._getHiddenCanvas=function(b,d,h,e,k,l){d=b._id+"_"+d;b=a._canvasCache[d];if(l)return b;
if(k||!b||b.width!=h||b.height!=e)b=document.createElement("canvas"),b.width=b.style.width=h,b.height=b.style.height=e,b.id=d,a._canvasCache[d]=b;return b};a._setCanvasImage=function(a,b,d,h,e){a.buf32=null;a.width=b;a.height=d;a.getContext("2d").drawImage(a.image,0,0,h||b,e||d,0,0,b,d)};a._apply=function(a,b){return a(b)}})(Jmol);
...
script:this._color?'background "'+this._color+'"':"",code:"JmolApplet.class"};a._setAppletParams(this._availableParams,m,e);var s;e.inlineModel?(s=e.inlineModel,s=s.replace(/\r|\n|\r\n/g,0<=s.indexOf("|")?"\\/n":"|").replace(/'/g,"&#39;"),a._debugAlert&&alert("inline model:\n"+s)):s="";m.loadInline=s;m.appletReadyCallback="Jmol._readyCallback";a._syncedApplets.length&&(m.synccallback="Jmol._mySyncCallback");m.java_arguments="-Xmx"+Math.round(e.memoryLimit||this._memoryLimit)+"m";this._initialize(e.jarPath,
...
alert(e);return a._documentWrite(e)};m._getCheckbox=function(k,e,h,l,t,s,b){var d=m._getIdForControl(k,e);null!=d&&(d=m._getIdForControl(k,h));if(null==d)return"";void 0!=s&&null!=s||(s="jmolCheckbox"+m._checkboxCount);++m._checkboxCount;if(void 0==e||null==e||void 0==h||null==h)alert("jmolCheckbox requires two scripts");else if(void 0==l||null==l)alert("jmolCheckbox requires a label");else return m._actions[s]=[m._addScript(d,e),m._addScript(d,h)],k="</span>",t='<span id="span_'+s+'"'+(b?' title="'+
b+'"':"")+"><input type='checkbox' name='"+s+"' id='"+s+"' onclick='Jmol.controls._cbClick(this)' onmouseover='Jmol.controls._cbOver(this);return true' onmouseout='Jmol.controls._mouseOut()' "+(t?"checked='true' ":"")+m._checkboxCssText+" />",0<=l.toLowerCase().indexOf("<td>")&&(t+=k,k=""),t+='<label for="'+s+'">'+l+"</label>"+k,a._debugAlert&&alert(t),a._documentWrite(t)};m._getCommandInput=function(k,e,h,l,t,s){k=m._getIdForControl(k,"x");if(null==k)return"";void 0!=l&&null!=l||(l="jmolCmd"+m._cmdCount);
void 0!=e&&null!=e||(e="Execute");void 0!=h&&!isNaN(h)||(h=60);void 0!=s||(s="help");++m._cmdCount;e='<span id="span_'+l+'"'+(t?' title="'+t+'"':"")+"><input name='"+l+"' id='"+l+"' size='"+h+"' onkeydown='return Jmol.controls._commandKeyPress(event,\""+l+'","'+k+"\")' value='"+s+"'/><input  type='button' name='"+l+"Btn' id='"+l+"Btn' value = '"+e+"' onclick='Jmol.controls._commandKeyPress(13,\""+l+'","'+k+"\")' /></span>";a._debugAlert&&alert(e);return a._documentWrite(e)};m._getLink=function(k,
...
m._getMenu=function(k,e,h,l,t){var s=m._getIdForControl(k,null);void 0!=l&&null!=l||(l="jmolMenu"+m._menuCount);++m._menuCount;s=typeof e;if(null!=s&&"object"==s&&e.length){var b=e.length;"number"!=typeof h||1==h?h=null:0>h&&(h=b);h='<span id="span_'+l+'"'+(t?' title="'+t+'"':"")+"><select name='"+l+"' id='"+l+"' onChange='Jmol.controls._menuSelected(this)'"+(h?" size='"+h+"' ":"")+m._menuCssText+">";for(l=0;l<b;++l){var d=e[l],s=typeof d,c=null,r=t=null;"object"==s&&null!=d?(c=d[0],t=d[1],r=d[2]):
c=t=d;s=m._getIdForControl(k,c);if(null==s)return"";null==t&&(t=c);"#optgroup"==c?h+="<optgroup label='"+t+"'>":"#optgroupEnd"==c?h+="</optgroup>":(s=m._addScript(s,c),h+="<option value='"+s+(r?"' selected='true'>":"'>")+t+"</option>")}h+="</select></span>";a._debugAlert&&alert(h);return a._documentWrite(h)}};m._getRadio=function(k,e,h,l,t,s,b,d){0==m._radioGroupCount&&++m._radioGroupCount;s||(s="jmolRadioGroup"+(m._radioGroupCount-1));k=m._radio(k,e,h,l,t,s,b?b:s+"_"+m._radioCount,d?d:0);if(null==
k)return"";a._debugAlert&&alert(k);return a._documentWrite(k)};m._getRadioGroup=function(k,e,h,l,t,s){var b=typeof e;if("object"!=b||null==b||!e.length)alert("invalid arrayOfRadioButtons");else{void 0!=h&&null!=h||(h="&#xa0; ");var d=e.length;++m._radioGroupCount;l||(l="jmolRadioGroup"+(m._radioGroupCount-1));for(var c="<span id='"+(t?t:l)+"'>",r=0;r<d;++r){r==d-1&&(h="");var C=e[r],b=typeof C,D=null,c="object"==b?c+(D=m._radio(k,C[0],C[1],C[2],h,l,3<C.length?C[3]:(t?t:l)+"_"+r,4<C.length?C[4]:0,
s)):c+(D=m._radio(k,C,null,null,h,l,(t?t:l)+"_"+r,s));if(null==D)return""}c+="</span>";a._debugAlert&&alert(c);return a._documentWrite(c)}}})(Jmol);
...
a.jmolButton=function(k,e,h,l,m){return a.controls._getButton(k,e,h,l,m)};a.jmolCheckbox=function(k,e,h,l,m,s,b){return a.controls._getCheckbox(k,e,h,l,m,s,b)};a.jmolCommandInput=function(k,e,h,l,m,s){return a.controls._getCommandInput(k,e,h,l,m,s)};a.jmolHtml=function(k){return a._documentWrite(k)};a.jmolLink=function(k,e,h,l,m){return a.controls._getLink(k,e,h,l,m)};a.jmolMenu=function(k,e,h,l,m){return a.controls._getMenu(k,e,h,l,m)};a.jmolRadio=function(k,e,h,l,m,s,b,d){return a.controls._getRadio(k,
e,h,l,m,s,b,d)};a.jmolRadioGroup=function(k,e,h,l,m,s){return a.controls._getRadioGroup(k,e,h,l,m,s)};a.setCheckboxGroup=function(k,e){a.controls._cbSetCheckboxGroup(k,e,arguments)};a.setDocument=function(k){a._document=k};a.setXHTML=function(k){a._isXHTML=!0;a._XhtmlElement=null;a._XhtmlAppendChild=!1;k&&(a._XhtmlElement=document.getElementById(k),a._XhtmlAppendChild=!0)};a.setAppletCss=function(k,e){null!=k&&(a._appletCssClass=k);a._appletCssText=e?e+" ":k?'class="'+k+'" ':""};a.setButtonCss=function(k,
...
c;try{null.hello()}catch(r){if(l=function(a,b,c){c||(c="[^\\s]+");var d=a.indexOf(b);a=a.substring(0,d)+c+a.substring(d+b.length);return RegExp("^"+a+"$")},/Opera[\/\s](\d+\.\d+)/.test(navigator.userAgent)){var l=r.message.indexOf(":"),C=r.message.indexOf(":",l+2),D=r.message.substr(l+1,C-l-20);c=function(a){return-1!=a.message.indexOf(D)}}else if(-1!=navigator.userAgent.toLowerCase().indexOf("webkit")){var T=l(r.message,"hello");c=function(a){return T.test(a.message)}}else T=l(r.message,"$$o$$"),
c=function(a){return T.test(a.message)}}a.exceptionOf=function(b,d){if(b.__CLASS_NAME__)return a.instanceOf(b,d);b.getMessage||(b.getMessage=function(){return""+this});b.printStackTrace||(b.printStackTrace=function(){},alert(b+" try/catch path:"+a.getStackTrace(-10)));if(d==Error){if(0>(""+b).indexOf("Error"))return!1;System.out.println(a.getStackTrace());return!0}return d==Exception||d==Throwable||d==NullPointerException&&c(b)};a.getStackTrace=function(a){a||(a=25);var b="\n",c=arguments.callee,
...
"construct",c,d);b.con$truct&&(b.con$truct.index=b.con$truct.stacks.length)};a.overrideConstructor=function(b,c,d){a.overrideMethod(b,"construct",c,d);b.con$truct&&(b.con$truct.index=b.con$truct.stacks.length)};a.defineMethod=function(b,c,e,k){a.assureInnerClass&&a.assureInnerClass(b,e);e.exName=c;k=L(k);var l=b.prototype,m=l[c];a._Loader._checkLoad&&P(b,c,k);if(!m||m.claxxOwner===b&&m.funParams==k)return e.funParams=k,e.claxxOwner=b,e.exClazz=b,l[c]=e;var s=null,r=m.stacks;r||(r=[],s=m,m.claxxOwner&&
(r[0]=s.claxxOwner));if(!m.stacks||m.claxxReference!==b){var t=++Xa,m=function(){var b;a:{var c=arguments.callee.claxxReference,j=arguments.callee.methodName;b=arguments;fx=this[j];var e=a.getParamsType(b),n="SAEM "+c.__CLASS_NAME__+"."+j+"("+e+")\n";300<xxxSAEMlist.length&&(xxxSAEMlist="");xxxSAEMlist+=n;if(!fx)try{System.out.println(a.getStackTrace(5))}catch(p){}h&&(n=t+" "+c.__CLASS_NAME__+" "+j+" ",0>Q.indexOf(n)&&(Q+=n+"\n"),h[n]||(h[n]=0),h[n]++);if(fx.lastParams==e.typeString&&fx.lastClaxxRef===
c){if(e.hasCastedNull){c=[];for(j=0;j<b.length;j++)c[j]=b[j]instanceof a.CastedNull?null:b[j]}else c=b;b=fx.lastMethod?fx.lastMethod.apply(this,c):null}else{fx.lastParams=e.typeString;fx.lastClaxxRef=c;n=fx.stacks;n||(n=c.prototype[j].stacks);for(var k=!1,l=n.length;0<=--l;)if(k||n[l]===c){var m=n[l].prototype[j],z=e,k=b,s=fx,r=[],I=!0,H=void 0;for(H in m)if(92==H.charCodeAt(0)){var w=H.substring(1).split("\\");w.length==z.length&&r.push(w);I=!1}else if(I&&"funParams"==H&&m.funParams){H=m.funParams;
w=H.substring(1).split("\\");w.length==z.length&&(r[0]=w);break}H=void 0;if(!(H=0==r.length)){H=void 0;for(var H=[],ea=r.length,w=0;w<ea;w++){for(var C=[],B=!0,Qb=r[w].length,D=0;D<Qb;D++)if(C[D]=a.getInheritedLevel(z[D],r[w][D]),0>C[D]){B=!1;break}B&&(C[z.length]=w,H.push(C))}if(0==H.length)H=null;else{ea=H[0];for(w=1;w<H.length;w++){C=!0;for(D=0;D<z.length;D++)if(ea[D]<H[w][D]){C=!1;break}C&&(ea=H[w])}H=r[ea[z.length]].join("\\")}H=!(r=H)}if(H)k=new d;else{m=I?m:m["\\"+r];I=null;if(z.hasCastedNull){I=
[];for(z=0;z<k.length;z++)I[z]=k[z]instanceof a.CastedNull?null:k[z]}else I=k;s.lastMethod=m;k=m.apply(this,I)}if(!(k instanceof d)){b=k;break a}k=!0}"construct"!=j&&Na(this,c,j,e.typeString);b=void 0}}return b};m.methodName=c;m.claxxReference=b;m=l[c]=m;c=[];for(l=0;l<r.length;l++)c[l]=r[l];m.stacks=c}r=m.stacks;0>tb(r,b)&&r.push(b);s&&(s.claxxOwner===b?(m[s.funParams]=s,s.claxxOwner=null,s.funParams=null):s.claxxOwner||(m["\\unknown"]=s));e.exClazz=b;m[k]=e;return m};duplicatedMethods={};var P=
function(b,c,d){var e=b.prototype[c];if(e&&(e.claxxOwner||e.claxxReference)===b)key=b.__CLASS_NAME__+"."+c+d,(b=duplicatedMethods[key])?(c="Warning! Duplicate method found for "+key,System.out.println(c),a.alert(c),duplicatedMethods[key]=b+1):duplicatedMethods[key]=1};a.showDuplicates=function(a){var b="",c=duplicatedMethods,d=0,e;for(e in c)1<c[e]&&(b+=c[e]+"\t"+e+"\n",d++);b="Duplicates: "+d+"\n\n"+b;System.out.println(b);a||alert(b)};var tb=function(a,b){if(a&&b)for(var c=a.length;0<=--c;)if(a[c]===
b)return c;return-1},Ma=function(a,b){var c=tb(a,b);if(0<=c){for(var d=a.length-1;c<d;c++)a[c]=a[c+1];a.length--;return!0}},L=function(a){return a?a.replace(/~([NABSO])/g,function(a,b){switch(b){case "N":return"n";case "B":return"b";case "S":return"String";case "O":return"Object";case "A":return"Array"}return"Unknown"}).replace(/\s+/g,"").replace(/^|,/g,"\\").replace(/\$/g,"org.eclipse.s"):"\\void"};a.overrideMethod=function(b,c,d,e){a.assureInnerClass&&a.assureInnerClass(b,d);d.exName=c;e=L(e);a._Loader._checkLoad&&
P(b,c,e);d.funParams=e;d.claxxOwner=b;return b.prototype[c]=d};var Q="";a.getProfile=function(){var a="";if(h){var a=[],b;for(b in h){var c=""+h[b];a.push("        ".substring(c.length)+c+"\t"+b)}a=a.sort().reverse().join("\r\n");h={}}return a+Q};a.getParamsType=function(b){var c=b.length;switch(c){case 0:var d=["void"];d.typeString="\\void";return d;case 1:switch(typeof obj){case "number":return d=["n"],d.typeString="\\n",d;case "boolean":return d=["b"],d.typeString="\\b",d}}d=[];d.hasCastedNull=
!1;if(b)for(var e=0;e<c;e++)d[e]=a.getClassName(b[e]),b[e]instanceof a.CastedNull&&(d.hasCastedNull=!0);d.typeString="\\"+d.join("\\");return d};var Xa=0;xxxSAEMlist="";a.allPackage={};a.allClasses={};a.lastPackageName=null;a.lastPackage=null;a.unloadedClasses=[];a.declarePackage=function(b){if(a.lastPackageName==b)return a.lastPackage;if(b&&b.length){for(var c=b.split(/\./),d=a.allPackage,e=0;e<c.length;e++)d[c[e]]||(d[c[e]]={__PKG_NAME__:d.__PKG_NAME__?d.__PKG_NAME__+"."+c[e]:c[e]},0==e&&a.setGlobal(c[e],
...
typeof f)return a.evalType(c);System.out.println("loadClass "+c);P("java")&&b.loadPackage("java");P("core")&&b.loadPackage("core");b.keepOnLoading=!0;if(!h&&(K&&c.lastIndexOf(".package")!=c.length-8||0!=c.indexOf("java.")&&!isClassDefined(ta)))wa.push([c,f]),System.out.println("loadclass-queuing"+c+ta+" "+isClassDefined(ta));else if((l=isClassDefined(c))||Q["@"+c]){if(l&&f&&(h=E(c),!h||h.status>=w.STATUS_LOAD_COMPLETE))k?window.setTimeout(f,25):f()}else{var m=b.getClasspathFor(c);l=e[m];if(!l)for(k=
G.length;0<=--k;)if(G[k].path==m||G[k].name==c){l=!0;break}if(l){if(f&&(l=E(c)))if(l.onLoaded){if(f!=l.onLoaded){var p=l.onLoaded,r=f;l.onLoaded=function(){p();r()}}}else l.onLoaded=f}else{l=a.unloadedClasses[c]&&E(c)||new w;l.name=c;l.path=m;l.isPackage=m.lastIndexOf("package.js")==m.length-10;R(m,c,l);l.onLoaded=f;l.status=w.STATUS_KNOWN;c=!1;for(k=G.length;0<=--k;)if(G[k].status!=w.STATUS_LOAD_COMPLETE){c=!0;break}if(l.isPackage){for(k=G.length;0<=--k&&!G[k].isPackage;)G[k+1]=G[k];G[++k]=l}else c&&
G.push(l);if(!c){var s=!1;f&&(s=fa,fa=!0);h&&(f=null);Ia(d,l,!0);X(l,l.path,l.requiredBy,!1,f?function(){fa=s;f()}:null)}}}};var P=function(a){return null!=window[a+".registered"]&&!N["@"+a]};b.loadPackage=function(a,c){c||(c=null);window[a+".registered"]=!1;b.loadPackageClasspath(a,b.J2SLibBase||(b.J2SLibBase=b.getJ2SLibBase()||"j2s/"),!0,c)};b.jarClasspath=function(a,b){b instanceof Array||(b=[classes]);D(b);for(var c=b.length;0<=--c;)N["#"+b[c]]=a;N["$"+a]=b};b.registerPackages=function(c,d){for(var e=
...
0;b._classPending={};b.showPending=function(){var a=[],c;for(c in b._classPending){var d=E(c);d?(a.push(d),System.out.println(ra("","",d,"",0))):alert("No node for "+c)}return a};var ra=function(a,b,c,d,e){b+="--"+c.name;a+=b+"\n";if(5<e)return a+(d+" ...\n");d+="\t";a+=d+"status: "+c.status+"\n";if(c.parents&&c.parents.length&&c.parents[0]&&c.parents[0].name){a+=d+"parents: "+c.parents.length+"\n";for(var f=0;f<c.parents.length;f++)a=ra(a,b,c.parents[f],d+"\t",e+1);a+="\n"}return a};updateNode=function(a){if(!a.name||
a.status>=w.STATUS_LOAD_COMPLETE)ua(a);else{var c=!0;if(a.musts.length&&a.declaration)for(var d=a.musts.length,e=d;0<=--e;){var f=a.musts[e];f.requiredBy=a;if(f.status<w.STATUS_DECLARED&&isClassDefined(f.name)){var h=[];f.status=w.STATUS_LOAD_COMPLETE;ua(f);if(f.declaration&&f.declaration.clazzList){for(var j=0,k=f.declaration.clazzList,l=k.length;j<l;j++){var m=E(k[j]);m&&(m.status!=w.STATUS_LOAD_COMPLETE&&m!==f)&&(m.status=f.status,m.declaration=null,ua(m),m.onLoaded&&h.push(m))}f.declaration=null}f.onLoaded&&
...
0;k=a.declaration.clazzList;for(l=k.length;j<l;j++)if((m=E(k[j]))&&m.status!=w.STATUS_DECLARED&&m!==a)m.status=w.STATUS_DECLARED,B&&(B[m.name]=!0),b.onScriptInitialized(m.path)}}c=w.STATUS_DECLARED;if(0==a.optionals.length&&0==a.musts.length||a.status>w.STATUS_KNOWN&&!a.declaration||Sa(a.musts,w.STATUS_LOAD_COMPLETE)&&Sa(a.optionals,w.STATUS_LOAD_COMPLETE)){c=w.STATUS_LOAD_COMPLETE;if(!ab(a,c))return!1;if(a.declaration&&a.declaration.clazzList){j=0;k=a.declaration.clazzList;for(l=k.length;j<l;j++)if((m=
E(k[j]))&&m.status!=c&&m!==a)if(m.declaration=null,!ab(m,c))return!1}}if(a.parents&&a.parents.length){for(e=0;e<a.parents.length;e++)j=a.parents[e],j.status<c&&updateNode(j,j.name);c==w.STATUS_LOAD_COMPLETE&&(a.parents=[])}}}};var Sa=function(a,b){for(var c=a.length;0<=--c;)if(a[c].status<b)return!1;return!0},ab=function(a,c){a.status=c;b.onScriptCompleted(a.path);var d=a.onLoaded;if(d&&(a.onLoaded=null,d(),!b.keepOnLoading))return!1;ua(a);return!0},bb={"r0.13412":1},ya=function(){for(;;){var a=Math.random(),
b="r"+a;if(!bb[b])return bb[b]=1,d.random=a}},E=function(a){ya();return Aa(a,d)},F=function(a){ya();return za(d,a)},Ha=function(a){return pa(d,a)},Aa=function(a,b){var c;return b.name==a?b:(c=$a(a,b.musts))||(c=$a(a,b.optionals))?c:null},$a=function(a,b){for(var c=d.random,e=b.length;0<=--e;){var f=b[e];if(f.name==a||f.random!=c&&(f.random=c,f=Aa(a,f)))return f}return null},xa=function(a,b){return a.status==b&&(b!=w.STATUS_KNOWN||!e[a.path])&&(b==w.STATUS_DECLARED||!isClassDefined(a.name))},pa=function(a,
b){for(var c=a.musts.length;0<=--c;){var d=a.musts[c];if(xa(d,b)||(d=pa(d,b)))return d}return xa(a,b)?a:null},za=function(a,b){var c;return(c=ma(a.musts,b))||(c=ma(a.optionals,b))||xa(c=a,b)?c:null},ma=function(a,b){if(a)for(var c=d.random,e=0;e<a.length;e++){var f=a[e];if(xa(f,b)||f.random!=c&&(f.random=c,f=za(f,b)))return f}return null},S={},ba=function(a,c,e,f){if(c instanceof Array){D(c);for(var h=0;h<c.length;h++)ba(a,c[h],e,f,c)}else{b._checkLoad&&!b._classPending[c]&&(b._classPending[c]=1,
0==b._classCountPending++&&(b._classCountOK=0),System.out.println("Loading class "+c));h=L["#"+c];h||(h=(h=E(c))?h:new w,h.name=c,h.path=N["#"+c]||"unknown",R(h.path,c,h),h.status=w.STATUS_KNOWN,Ia(d,h,!1));aa(h,a,!0);5==arguments.length&&f&&(f.status=h.status,f.clazzList=arguments[4]);if(h.declaration=f)h.status=w.STATUS_CONTENT_LOADED;aa(h,e,!1)}},aa=function(a,b,c){if(b&&b.length){D(b);for(var d=0;d<b.length;d++){var e=b[d];if(e&&!isClassDefined(e)&&!Q["@"+e]){var f=E(e);f||(f=new w,f.name=e,f.status=
w.STATUS_KNOWN);f.requiredBy=a;Ia(a,f,c)}}}};window.Clazz?a.load=ba:b.load=ba;var R=function(a,b,c){var d="@"+a;if(a=L[d])if(a instanceof Array){for(var d=!1,e=0;e<a.length;e++)if(a[e].name==b){d=!0;break}d||a.push(c)}else L[d]=[a,c];else L[d]=c;L["#"+b]=c},ga=function(a){var c=a.name;if(!isClassDefined(c)&&!Q["@"+c]){var d=b.getClasspathFor(c);a.path=d;R(d,c,a);if(!e[d])return X(a,d,a.requiredBy,!1),!0}return!1},ta=b.runtimeKeyClass="java.lang.String",wa=[];b.getJ2SLibBase=function(){var a=window["j2s.lib"];
return a?a.base+("."==a.alias?"":(a.alias?a.alias:a.version?a.version:"1.0.0")+"/"):null};var M=!0,W=!1,Y=-1;b.MODE_SCRIPT=4;b.MODE_XHR=2;b.MODE_SYNC=1;b.setLoadingMode=function(a,c){var d=!0,e=!0;"string"==typeof a?(a=a.toLowerCase(),0<=a.indexOf("script")?e=!1:a.indexOf("async"),d=!1):a&b.MODE_SCRIPT?e=!1:d=!(a&b.MODE_SYNC);W=e;Y=(M=d)&&0<=c?c:-1;return d};var Ba=function(){if(!K&&isClassDefined(ta)){for(var a=wa,c=0;c<a.length;c++)b.loadClass(a[c][0],a[c][1]);wa=[]}};b.loadZJar=function(a,c){var d=
null,e=c instanceof Array;e?c=c[c.length-1]:d=c==ta?Ba:null;b.jarClasspath(a,e?c:[c]);b.loadClass(c,d,!0)};var Ca={},Na=[],Ia=function(a,b,c){var e=!1;c?(c=a.musts,b.requiredBy||(b.requiredBy=a)):c=a.optionals;Ca[b.name]||(Na.push(b),Ca[b.name]=b);for(var f=0;f<c.length;f++)if(c[f].name==b.name){e=!0;break}e||(c.push(b),fa&&(0!=b.name.indexOf("java")&&0!=b.name.indexOf("net.sf.j2s.ajax"))&&(ja&&(fa=!1),ja=!0));a:{if(a.name&&a!=d&&a!=b)for(e=0;e<b.parents.length;e++)if(b.parents[e].name==a.name)break a;
b.parents.push(a)}},ua=function(a){var b=a.parents;if(b)for(var c=b.length;0<=--c;)Ma(b[c].musts,a)||Ma(b[c].optionals,a)};b.unloadClassExt=function(a){B&&(B[a]=!1);if(N["#"+a]){var c=N["#"+a];N["#"+a]=null;var d=N["$"+c];Ma(d,a)&&(N["$"+c]=d)}if(c=E(a))c.status=w.STATUS_KNOWN,e[c.path]=!1;c=b.getClasspathFor(a);e[c]=!1;S[c]&&(S[c]=!1);b.onClassUnloaded(a)};a.binaryFolders=b.binaryFolders=[b.getJ2SLibBase()]})(a,a._Loader);a._LoaderProgressMonitor={};var X=a._LoaderProgressMonitor,ja=null,G=0,U=null,
ka=0;X.DEFAULT_OPACITY=m&&m._j2sLoadMonitorOpacity?m._j2sLoadMonitorOpacity:55;X.hideMonitor=function(){U.style.display="none"};X.showStatus=function(a,b){if(!U){var c=document.createElement("DIV");c.id="_Loader-status";c.style.cssText="position:absolute;bottom:4px;left:4px;padding:2px 8px;z-index:"+(window["j2s.lib"].monitorZIndex||1E4)+";background-color:#8e0000;color:yellow;font-family:Arial, sans-serif;font-size:10pt;white-space:nowrap;";c.onmouseover=wb;U=c;document.body.appendChild(c);mb||(mb=
!0)}jb(U);if(null==a)b?la():X.hideMonitor();else{U.appendChild(document.createTextNode(""+a));"none"==U.style.display&&(U.style.display="");lb(X.DEFAULT_OPACITY);var d,c=navigator.userAgent;d=document.body;var e=d.parentNode,h=e.clientHeight;d=d.scrollTop+d.offsetTop;var k=e.scrollTop+e.offsetTop,c=0>c.indexOf("Opera")&&document.all?0==h?d:k:0>c.indexOf("Gecko")?h==e.offsetHeight&&h==e.scrollHeight?d:k:d;ka!=c&&(ka=c,U.style.bottom=ka+4+"px");b&&la()}};var jb=function(a){if(a)for(var b=a.childNodes.length;0<=
--b;){var c=a.childNodes[b];if(c){c.childNodes&&c.childNodes.length&&jb(c);try{a.removeChild(c)}catch(d){}}}},lb=function(a){ja&&a==X.DEFAULT_OPACITY&&(window.clearTimeout(ja),ja=null);G=a;navigator.userAgent.toLowerCase();U.style.filter="Alpha(Opacity="+a+")";U.style.opacity=a/100},wb=function(){X.hideMonitor()},mb=!1,la=function(){"none"!=U.style.display&&(G==X.DEFAULT_OPACITY?(ja=window.setTimeout(function(){la()},750),G-=5):0<=G-10?(lb(G-10),ja=window.setTimeout(function(){la()},40)):U.style.display=
"none")},B=a.Console,V=System;B.maxTotalLines=1E4;B.setMaxTotalLines=function(a){B.maxTotalLines=0<a?a:999999};B.maxLatency=40;B.setMaxLatency=function(a){B.maxLatency=0<a?a:40};B.pinning=!1;B.enablePinning=function(a){B.pinning=a};B.linesCount=0;B.metLineBreak=!1;B.createConsoleWindow=function(){var a=document.createElement("DIV");a.style.cssText="font-family:monospace, Arial, sans-serif;";document.body.appendChild(a);return a};var $=String.fromCharCode(160),$=$+($+$+$);B.consoleOutput=function(a,
b){var c=window["j2s.lib"];(c=c&&c.console)&&"string"==typeof c&&(c=document.getElementById(c));if(!c)return!1;if(B.linesCount>B.maxTotalLines){for(var d=0;d<B.linesCount-B.maxTotalLines;d++)c&&0<c.childNodes.length&&c.removeChild(c.childNodes[0]);B.linesCount=B.maxTotalLines}var e=!1;a=("undefined"==typeof a?"":null==a?"null":""+a).replace(/\t/g,$);if(0<a.length)switch(a.charAt(a.length-1)){case "\n":case "\r":a=1<a.length?a.substring(0,a.length-("\r"==a.charAt(a.length-2)?2:1)):"",e=!0}var h=null;
a=a.replace(/\t/g,$);for(var h=a.split(/\r\n|\r|\n/g),d=0,k=h.length-1;d<=k;d++){var l=null;if(B.metLineBreak||0==B.linesCount||1>c.childNodes.length)l=document.createElement("DIV"),c.appendChild(l),l.style.whiteSpace="nowrap",B.linesCount++;else try{l=c.childNodes[c.childNodes.length-1]}catch(m){l=document.createElement("DIV"),c.appendChild(l),l.style.whiteSpace="nowrap",B.linesCount++}var r=document.createElement("SPAN");l.appendChild(r);r.style.whiteSpace="nowrap";b&&(r.style.color=b);l=h[d];0==
l.length&&(l=$);r.appendChild(document.createTextNode(l));B.pinning||(c.scrollTop+=100);B.metLineBreak=d!=k||e}d=c.parentNode.className;!B.pinning&&(d&&-1!=d.indexOf("composite"))&&(c.parentNode.scrollTop=c.parentNode.scrollHeight);B.lastOutputTime=(new Date).getTime()};B.clear=function(){try{B.metLineBreak=!0;var a=window["j2s.lib"],b=a&&a.console;if(b&&(b=document.getElementById(b))){for(var c=b.childNodes,d=c.length;0<=--d;)b.removeChild(c[d]);B.linesCount=0}}catch(e){}};a.alert=function(a){B.consoleOutput(a+
"\r\n")};V.out.print=function(a){B.consoleOutput(a)};V.out.println=function(a){B.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n")};V.out.write=function(a,b,c){V.out.print(String.instantialize(a).substring(b,b+c))};V.err.__CLASS_NAME__="java.io.PrintStream";V.err.print=function(a){B.consoleOutput(a,"red")};V.err.println=function(a){B.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};V.err.write=function(a,b,c){V.err.print(String.instantialize(a).substring(b,
b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2015-08-08 17:46:34 -0400 (Sat, 08 Aug 2015) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.3.15_2015.08.08";
