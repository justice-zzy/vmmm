...
}if (report) eval.report (J.i18n.GT.o (J.i18n.GT._ ("{0} new bonds; {1} modified"),  Clazz_newArray (-1, [Integer.$valueOf (nNew), Integer.$valueOf (nModified)])));
}, "~N");
...
i = eval.iToken;
if (!this.chk) list.addLast ( Clazz_newArray (-1, [Integer.$valueOf (135266320), Float.$valueOf (timeSec), pt]));
continue;
case 528432:
switch (this.getToken (++i).tok) {
case 1112541205:
...
}if (!this.chk) list.addLast ( Clazz_newArray (-1, [Integer.$valueOf (269484210), Float.$valueOf (timeSec), Float.$valueOf (x), Float.$valueOf (y)]));
continue;
case 269484208:
continue;
case 1113200654:
...
list.addLast ( Clazz_newArray (-1, [Integer.$valueOf (1113200654), Float.$valueOf (timeSec), pathGuide]));
continue;
}break;
case 1073742084:
var path;
