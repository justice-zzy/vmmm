...
Clazz_declarePackage ("JM");
Clazz_load (null, "JM.ProteinStructure", ["java.util.Hashtable", "JU.P3", "$.V3", "JU.Logger"], function () {
c$ = Clazz_decorateAsClass (function () {
this.type = null;
this.subtype = null;
this.structureID = null;
...
Clazz_declarePackage ("JM");
Clazz_load (["JU.V3"], "JM.BioPolymer", ["java.lang.Float", "JU.BS", "$.P3"], function () {
c$ = Clazz_decorateAsClass (function () {
this.model = null;
this.monomers = null;
...
function (conformationIndex0, doSet, bsConformation, bsRet) {
...
for (var i = bsConformation.nextSetBit (0); i >= 0; i = bsConformation.nextSetBit (i + 1)) {
var atom = atoms[i];
...
Clazz_load (["J.render.MeshRenderer", "JU.A4", "$.BS", "$.M3", "$.P3", "$.V3"], "J.renderbio.BioShapeRenderer", ["J.c.STR", "JM.CarbohydratePolymer", "$.NucleicPolymer", "J.shape.Mesh", "JU.C", "$.GData", "$.Logger", "$.Normix"], function () {
c$ = Clazz_decorateAsClass (function () {
...
}this.renderMesh2 (this.meshes[i]);
}
});
Clazz_defineStatics (c$,
