...
function () {
if (!this.isMMCIF || !this.finalizeSubclass ()) this.applySymmetryAndSetTrajectory ();
...
this.disableField (4);
this.disableField (5);
if (this.fieldOf[16] != -1 && !this.isMMCIF) {
this.setIsPDB ();
this.isMMCIF = true;
...
if (seqID > 0) {
var pt = atom.vib;
if (pt == null) pt = this.asc.addVibrationVector (atom.index, 0, NaN, 1095761941);
pt.x = seqID;
}}this.ac++;
...
bondCount++;
this.bondTypes.addLast ( Clazz.newArray (-1, [name1, name2, Float.$valueOf (distance), Float.$valueOf (dx), order]));
}
if (bondCount > 0) {
...
"CITATION_ID", 0,
"CITATION_TITLE", 1,
"citationFields",  Clazz.newArray (-1, ["_citation_id", "_citation_title"]),
"SYM_XYZ", 0,
"SYM_MAGN_XYZ", 1,
"SYM_SSG_ALG", 2,
"SYM_MAGN_SSG_ALG", 3,
